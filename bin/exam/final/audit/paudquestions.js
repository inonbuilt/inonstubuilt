const descriptiveQuestions = [
  {
    question_id: "AUD_MTPMAR24_1A",
    source: "ICAI Mock Test Paper - Series I, March 2024",
    chapter_name: "Audit Evidence – Inventory Counting (SA 501)",
    placement: 1,
    marks: 5,
    question_html: `
      <p> While conducting the statutory audit of Tasty Foods Limited, CA. Careful has planned attendance at physical inventory count of the company from 29<sup>th</sup> March to 31<sup>st</sup> March 2024.</p>

      <p>The company is engaged in the business of extracting rice from paddy grains and caters to domestic as well as international market particularly in Gulf region. It has its plant spread in an area of about 20 acres located in National Capital Region (NCR). Paddy contained in jute bags of nearly standard sizes is purchased from dealers/agents. It is stored in heaps on pallets (kind of wooden structures) in open area covered by protective sheets and in steel silos (silos are huge steel containers with measuring strain gauges) in company’s premises.</p>

      <p>The company mainly produces three rice brands viz. <strong>"Raja"</strong> and <strong>"Shehzada"</strong> (both for the domestic market) and <strong>"Badshah"</strong> (for the international market). The process of obtaining rice from paddy consists of various steps like cleaning of paddy, removing outer husk layer from paddy grains to obtain brown rice, whitening, polishing, grading and sorting, packaging, which is accomplished by means of various types of machineries installed in the plant.</p>

      <p>The company’s management has prepared a set of instructions and procedures to be followed for recording and controlling results of company’s physical inventory counting which are listed as under:</p>

      <ul>
        <li>The physical inventory count process is to be supervised by a responsible officer of company responsible for storage functions.</li>
        <li>There should be no disturbance to the routine process of receiving goods and despatch during the counting time period.</li>
        <li>Counting process is to be undertaken by constituting different teams of 3 members each for counting/verifying raw material, work in progress and finished goods.</li>
        <li>Paddy in steel silos is to be estimated using their capacity.</li>
        <li>Quantity of work in progress is to be estimated considering plant capacity as whole.</li>
        <li>The responsible officer should ensure that stocks have been counted/verified in all areas.</li>
      </ul>

      <p><strong>Before proceeding to attend physical inventory count process of company, evaluate management’s instructions and procedures sent to CA. Careful as stated above. You may suggest modification, addition or removal of such instructions to ensure effective count process.</strong></p>
    `,
    solution_html: `
      <strong>Solution:</strong><br><br>

      <p>The set of instructions and procedures given in the case scenario are incomplete and not properly framed. The following modifications/additions are required to ensure an effective physical inventory count:</p>

      <ol>
        <li>
          <strong>Supervision of Inventory Count</strong><br>
          The physical inventory count should preferably be supervised by a responsible officer from the <strong>Finance Department</strong> and not by the officer responsible for storage functions. However, the storage in-charge of each area should remain present for coordination and facilitation.
        </li>

        <li>
          <strong>Movement of Goods</strong><br>
          During the inventory count process, inward and outward movement of goods should <strong>not be allowed</strong>. Allowing such movement may distort the count results and make reconciliation difficult.
        </li>

        <li>
          <strong>Constitution of Counting Teams</strong><br>
          The instructions should specify that team members should preferably be drawn from departments <strong>not connected with storage functions</strong> (e.g., Finance Department). Duties of counting and recording should be assigned separately, and serially numbered count sheets should be used. Distinctive tags or marks should be placed after completion of counting in each area.
        </li>

        <li>
          <strong>Count Sheets</strong><br>
          Count sheets should contain proper descriptions of inventory items in accordance with the company's inventory records.
        </li>

        <li>
          <strong>Coverage of All Areas</strong><br>
          The management should provide layout plans of different storage sections so that all inventory locations are adequately covered during counting.
        </li>

        <li>
          <strong>Counting of Paddy Stored in Open Area</strong><br>
          Paddy stored in jute bags in open heaps should be counted by determining the number of bags in each heap. Since bags are of nearly standard size, quantity can be determined by multiplying the number of bags with the standard weight per bag.
        </li>

        <li>
          <strong>Verification of Paddy in Steel Silos</strong><br>
          Paddy stored in steel silos should be measured using the <strong>measuring strain gauges</strong> installed in the silos instead of estimating quantity merely on the basis of silo capacity.
        </li>

        <li>
          <strong>Work-in-Progress (WIP)</strong><br>
          WIP should be estimated at <strong>each stage of production</strong> rather than considering the plant as a whole, to obtain accurate quantities.
        </li>

        <li>
          <strong>Finished Goods</strong><br>
          Finished goods should be counted <strong>brand-wise</strong> by verifying the rice bags according to the respective brand names.
        </li>

        <li>
          <strong>Damaged or Obsolete Inventory</strong><br>
          Separate identification, counting and storage should be made for damaged or obsolete inventory to prevent it from being mixed with usable stock.
        </li>

        <li>
          <strong>Authentication of Count Sheets</strong><br>
          Each count sheet should be signed by all team members after completion of counting.
        </li>

        <li>
          <strong>Final Verification</strong><br>
          The responsible officer should ensure that inventory has been counted in all areas and that distinctive marks/tags have been placed to indicate completion of counting.
        </li>
      </ol>
    `
  },
  {
    question_id: "AUD_MTPMAR24_1B",
    source: "ICAI Mock Test Paper - Series I, March 2024",
    chapter_name: "External Confirmations, Key Audit Matters & Modified Opinion (SA 505, SA 701, SA 705)",
    placement: 1,
    marks: 5,
    question_html: `
      <p> While conducting audit of CGX Limited, a listed company, for year 2022-23, CA. Srishti notices that company has extinguished following material liabilities unilaterally without entering into settlement with creditors and reported these amounts as gains under <strong>“Other income”</strong>. The details in this respect are as under:</p>
      ...
      <table border="1" cellspacing="0" cellpadding="5">
        ...
        <tr>
          <td>(i)</td>
          <td>Liabilities for purchases of raw material were written back on account of poor quality of raw material and difference in rates.</td>
          <td>₹ 3.50 crores</td>
        </tr>
        <tr>
          <td>(ii)</td>
          <td>Liabilities for capital goods were written back on account of defects in machinery supplied by creditors.</td>
          <td>₹ 2.00 crores</td>
        </tr>
      </table>

      <p>The management is of the opinion that these dues are no longer payable. Therefore, retaining these liabilities in financial statements would lead to overstatement of liabilities. Extinguishment of liabilities was made by company in accordance with normal trade practices and outstandings were written back after stopping dealing with such creditors.</p>

      <p>She wanted to send external confirmation requests to such creditors. However, management informed her that sending such requests may be used by creditors as proof of existence of liability.</p>

      <p>She is contemplating inclusion of above matters under <strong>“Key Audit Matters”</strong> in audit report.</p>

      <p><strong>Analyse the situation threadbare.</strong></p>
    `,
    solution_html: `
      <strong>Solution:</strong><br><br>

      <p>A liability is a present obligation of the entity to transfer an economic resource as a result of past events. Instead of fulfilling an obligation to transfer an economic resource to the party that has a right to receive that resource, entities sometimes decide to:</p>

      <ol type="a">
        <li>Settle the obligation by negotiating a release from the obligation.</li>
        <li>Transfer the obligation to a third party.</li>
        <li>Replace that obligation to transfer an economic resource with another obligation by entering into a new transaction.</li>
      </ol>

      <p>In the above situations, an entity has the obligation to transfer an economic resource until it has <strong>settled, transferred or replaced</strong> that obligation.</p>

      <p>In the given situation, the company has written back liabilities due to creditors <strong>unilaterally</strong>. The company has not settled the obligation by negotiating a release from the obligation from the respective creditors. Such an accounting treatment by the management is questionable and is against the <strong>Conceptual Framework for Financial Reporting under Ind AS.</strong></p>

      <p>CA. Srishti wanted to send external confirmations in accordance with <strong>SA 505, "External Confirmations"</strong>, but management informed her that sending such requests may be used by creditors as proof of existence of liability.</p>

      <p>She should display <strong>professional skepticism</strong> and be alert to the possibility of material misstatements in the financial statements if restrained by management from obtaining external confirmations. The reasons advanced by management do not appear to be valid and reasonable.</p>

      <p>In accordance with <strong>SA 505</strong>, she should reassess the risks and perform alternative audit procedures to mitigate such risks. Besides, she should also consider the implications of the same for her audit opinion.</p>

      <p>Further, <strong>SA 705, "Modifications to the Opinion in the Independent Auditor's Report"</strong> requires that the auditor shall modify the opinion in the auditor's report when:</p>
      ...
      <p>SA 705 also states that misstatements in financial statements arise when selected accounting policies are not in accordance with the applicable financial reporting framework.</p>

      <p>It also states that examples of an inability to obtain sufficient appropriate audit evidence arise from a limitation on the scope of audit imposed by management when management prevents the auditor from requesting external confirmation of specific account balances.</p>

      <p>Therefore, she needs to issue a <strong>modified opinion</strong>.</p>

      <p>Keeping in view the above, her contemplation of including the above matters under <strong>"Key Audit Matters"</strong> is not proper and is not in accordance with <strong>SA 701, "Communicating Key Audit Matters in the Independent Auditor's Report".</strong></p>

      <p>SA 701 states that the auditor shall <strong>not communicate a matter in the Key Audit Matters section</strong> of the auditor's report when the auditor would be required to modify the opinion in accordance with SA 705 as a result of that matter.</p>

      <p>Communicating Key Audit Matters in the auditor's report is <strong>not a substitute</strong> for the auditor expressing a modified opinion when required by the circumstances of a specific audit engagement in accordance with SA 705.</p>
    `
  },
  {
    question_id: "AUD_MTPMAR24_1C",
    source: "ICAI Mock Test Paper - Series I, March 2024",
    chapter_name: "Audit Considerations Relating to an Entity Using a Service Organisation (SA 402)",
    placement: 1,
    marks: 4,
    question_html: `
      <p> FAB Limited is availing the services of Atiya Private Limited for its payroll operations. Payroll cost accounts for <strong>63%</strong> of total cost for FAB Limited. Atiya Private Limited has provided the <strong>Type 2 Report</strong> as specified under SA 402 for its description, design and operating effectiveness of controls.</p>

      <p>Atiya Private Limited has also outsourced a material part of payroll operation to <strong>M/s RST & Associates</strong> in such a way that M/s RST & Associates is a <strong>sub-service organisation</strong> to FAB Limited. The Type 2 Report which was provided by Atiya Private Limited was based on the <strong>carve-out method</strong> as specified under SA 402.</p>

      <p>CA. Akram, while reviewing the unmodified audit report drafted by his assistant, found that a reference had been made to the work done by the service auditor. CA. Akram, hence, asked his assistant to remove such reference and modify the report accordingly.</p>

      <p><strong>Comment whether CA. Akram is correct in removing the reference of the work done by the service auditor.</strong></p>
    `,
    solution_html: `
      <strong>Solution:</strong><br><br>

      <p><strong>Reporting by the User Auditor:</strong> As per <strong>SA 402, "Audit Considerations Relating to an Entity Using a Service Organisation"</strong>, the user auditor shall modify the opinion in the user auditor's report in accordance with <strong>SA 705, "Modifications to the Opinion in the Independent Auditor's Report"</strong>, if the user auditor is unable to obtain sufficient appropriate audit evidence regarding the services provided by the service organisation relevant to the audit of the user entity's financial statements.</p>

      <p>The user auditor shall <strong>not refer to the work of a service auditor</strong> in the user auditor's report containing an <strong>unmodified opinion</strong> unless required by law or regulation to do so.</p>

      <p>If such reference is required by law or regulation, the user auditor's report shall indicate that the reference <strong>does not diminish the user auditor's responsibility</strong> for the audit opinion.</p>

      <p>Thus, in view of the above, the contention of <strong>CA. Akram</strong> in removing the reference of the work done by the service auditor is <strong>correct</strong>, as in the case of an <strong>unmodified audit report</strong>, the user auditor cannot refer to the work done by the service auditor.</p>
    `
  },
  {
    question_id: "AUD_MTPMAR24_2A",
    source: "ICAI Mock Test Paper - Series I, March 2024",
    chapter_name: "Quality Control for Audit Firms (SQC 1)",
    placement: 2,
    marks: 5,
    question_html: `
      <p> TPX & Co., Chartered Accountants is a large audit firm. It maintains audit documentation both electronically and in physical form (hard files). The physical files are neither scanned and incorporated into electronic files nor cross-referenced to the electronic files.</p>

      <p>Further, there are many instances where audit working papers do not contain details as to whether information was obtained from client or prepared by engagement team.</p>

      <p><strong>How do you view the above situation from the point of view of quality control system in audit firm? Analyse.</strong></p>
    `,
    solution_html: `
      <strong>Solution:</strong><br><br>

      <p>In accordance with <strong>SQC 1, "Quality Control for Firms that Perform Audits and Reviews of Historical Financial Information and Other Assurance and Related Services Engagements"</strong>, the firm should establish policies and procedures designed to maintain <strong>confidentiality, safe custody, integrity, accessibility and retrievability</strong> of engagement documentation.</p>

      <p>In the given situation, the physical files are neither scanned and incorporated into the electronic files nor cross-referenced to the electronic files. Inability to do so shows that the firm has not established policies and procedures to maintain the <strong>integrity</strong> of engagement documentation.</p>

      <p>Lack of ensuring the same makes it difficult to demonstrate completeness of audit files and whether these were assembled within the <strong>60 days timeframe</strong> stipulated in SQC 1.</p>

      <p>Where engagement documentation is in paper, electronic or other media, the integrity, accessibility or retrievability of the underlying data may be compromised if the documentation could be altered, added to or deleted without the firm's knowledge, or if it could be permanently lost or damaged.</p>

      <p>One of the reasons for designing and implementing appropriate controls for engagement documentation in this regard is the protection of the integrity of information at all stages of the engagement.</p>

      <p>For practical reasons, original paper documentation may be electronically scanned for inclusion in engagement files. In that case, the firm should implement appropriate procedures requiring engagement teams to:</p>

      <ol type="a">
        <li>Generate scanned copies that reflect the entire content of the original paper documentation, including manual signatures, cross-references and annotations.</li>

        <li>Integrate the scanned copies into the engagement files, including indexing and signing off on the scanned copies as necessary.</li>

        <li>Enable the scanned copies to be retrieved and print as necessary.</li>
      </ol>

      <p>It has also been stated that there are many instances where audit working papers do not contain details as to whether information was obtained from the client or prepared by the engagement team.</p>

      <p>It is important to identify the <strong>source of the document</strong> and the information used as audit evidence to ensure its reliability. Failure to do so could have potential risks of <strong>non-compliance with the Standards on Auditing</strong>.</p>
    `
  },
  {
    question_id: "AUD_MTPMAR24_2B",
    source: "ICAI Mock Test Paper - Series I, March 2024",
    chapter_name: "Understanding IT Dependencies in Audit",
    placement: 2,
    marks: 4,
    question_html: `
      <p> IT dependencies also arise due to <strong>“system generated reports”</strong> and <strong>“interfaces”</strong>.</p>

      <p><strong>How do such IT dependencies arise? Why is it important to identify IT dependencies to develop an effective and efficient audit approach?</strong></p>
    `,
    solution_html: `
      <strong>Solution:</strong><br><br>

      <p>IT dependencies are created when IT is used to <strong>initiate, authorize, record, process, or report transactions</strong> or other financial data for inclusion in the financial statements.</p>

      <p><strong>System Generated Reports:</strong> These are the information generated by the IT systems. These reports are often used in an entity's execution of a manual control, including business performance reviews, or may be the source of entity information used by the auditor when selecting items for testing, performing substantive tests of details or performing a substantive analytical procedure.</p>

      <p><strong>Examples:</strong> Vendor master report, Customer ageing report.</p>

      <p><strong>Interfaces:</strong> Interfaces are programmed logic that transfer the data from one IT system to another. For example, an interface may be programmed to transfer data from a payroll sub-ledger to the general ledger.</p>

      <p>In this manner, IT dependencies arise due to <strong>system generated reports</strong> and <strong>interfaces</strong>.</p>

      <p>Identifying and documenting the entity's IT dependencies in a consistent and clear manner helps to:</p>

      <ul>
        <li>Identify the entity's reliance upon IT.</li>
        <li>Understand how IT is integrated into the entity's business model.</li>
        <li>Identify potential risks arising from the use of IT.</li>
        <li>Identify related IT General Controls (ITGCs).</li>
        <li>Develop an effective and efficient audit approach.</li>
      </ul>
    `
  },
  {
    question_id: "AUD_MTPMAR24_2C",
    source: "ICAI Mock Test Paper - Series I, March 2024",
    chapter_name: "Chartered Accountants Act, 1949 - Management Consultancy & Other Services",
    placement: 2,
    marks: 5,
    question_html: `
      <p> CA. Gyan is a Chartered Accountant in practice and also an engineer by qualification. He wants to pursue a registered valuer course and work as a registered valuer for <strong>Plant and Machinery</strong> under the <strong>Companies Act, 2013</strong>.</p>

      <p><strong>Comment on the above with reference to the provisions of the Chartered Accountants Act, 1949.</strong></p>
    `,
    solution_html: `
      <strong>Solution:</strong><br><br>

      <p>As per <strong>Section 2(2)(iv)</strong> of the <strong>Chartered Accountants Act, 1949</strong>, a member of the Institute shall be deemed <strong>"to be in practice"</strong> when, individually or in partnership with Chartered Accountants in practice or in partnership with members of such other recognised professions as may be prescribed, he, in consideration of remuneration received or to be received, renders such other services as, in the opinion of the Council, are or may be rendered by a Chartered Accountant in practice.</p>

      <p>Pursuant to Section 2(2)(iv) above, the Council has passed a resolution permitting a Chartered Accountant in practice to render the entire range of <strong>"Management Consultancy and Other Services"</strong>, which, inter alia, includes rendering services of valuation of shares and business, advice regarding amalgamation, merger and acquisition, and acting as a <strong>Registered Valuer</strong> under the Companies Act, 2013 read with the Companies (Registered Valuers and Valuation) Rules, 2017.</p>

      <p>However, such Rules qualify Chartered Accountants for valuation of <strong>securities or financial assets only</strong> and <strong>not for Plant and Machinery</strong>. Therefore, valuation of Plant and Machinery does not form part of the Management Consultancy and Other Services permitted by the Council.</p>

      <p>Further, in accordance with the resolution passed under <strong>Regulation 190A</strong> of the Chartered Accountants Regulations, 1988, members in practice are generally permitted to attend classes and appear for any examination. There is no requirement to obtain prior permission of ICAI in this regard.</p>

      <p>Therefore, it is generally permissible for a member in practice to attend classes and appear for the Registered Valuer examination. Accordingly, pursuing the Registered Valuer course is permissible.</p>

      <p><strong>Hence, keeping in view the above and in terms of the provisions of the Chartered Accountants Act, 1949 and the Code of Ethics, it is <u>not permissible</u> for a Chartered Accountant in practice to work as an Engineer/Valuer in Plant and Machinery simultaneously.</strong></p>
    `
  },
  {
    question_id: "AUD_MTPMAR24_3A",
    source: "ICAI Mock Test Paper - Series I, March 2024",
    chapter_name: "Auditing Accounting Estimates (SA 540)",
    placement: 3,
    marks: 4,
    question_html: `
      <p> Jagdish Pvt. Ltd. is engaged in the business of real estate. The auditor of the company requested the information from the management to review the outcome of accounting estimates (like estimated costs considered for percentage completion etc.) included in the prior period financial statements and their subsequent re-estimation for the purpose of the current period.</p>
    ...
    solution_html: `
      ...
      <p>The review of prior period accounting estimates may also assist the auditor, in the current period, in identifying circumstances or conditions that increase the susceptibility of accounting estimates to, or indicate the presence of, possible management bias.</p>

      <p>The auditor's professional skepticism assists in identifying such circumstances or conditions and in determining the nature, timing and extent of further audit procedures.</p>

      <p>However, the review is <strong>not intended to call into question the judgments made in the prior periods</strong> that were based on information available at that time.</p>

      <p>In the given case, the <strong>management is not correct</strong> in refusing the relevant information to the auditor.</p>
    `
  },
  {
    question_id: "AUD_MTPMAR24_3B",
    source: "ICAI Mock Test Paper - Series I, March 2024",
    chapter_name: "Audit of Banks – Non-Performing Assets (NPAs)",
    placement: 3,
    marks: 5,
    question_html: `
      <p> RML & Associates are one of the joint auditors of IND Bank for the year 2022-23. While auditing IND Bank, they are analysing industry data relating to NPAs in select public sector banks as part of risk assessment procedures:</p>

      <table border="1" cellspacing="0" cellpadding="5">
        <tr>
          <th>Name of Bank</th>
          <th>Gross NPAs (₹ crore)</th>
          <th>Net NPAs (₹ crore)</th>
          <th>Ratio of Net NPAs to Net Advances</th>
        </tr>
        <tr>
          <td>BIC Bank</td>
          <td>55,000</td>
      ...
      <p><strong>In the above context, what do you understand by “Gross NPAs” and “Net NPAs” as on reporting date in the context of financial statements of a Bank? As an auditor of IND Bank, what inference would you draw by comparing the “Ratio of Net NPAs to Net Advances” with other public sector banks?</strong></p>
    `,
    solution_html: `
      <strong>Solution:</strong><br><br>

      <p><strong>Gross NPAs</strong> represent opening balances of NPAs as increased by fresh NPAs during the year and reduced by upgradations, recoveries and write-offs during the year.</p>

      <p><strong>Net NPAs</strong> are arrived at after deducting amounts on account of the total provision held against NPAs, balance in the interest suspense account to park accrued interest on NPAs and certain other adjustments.</p>

      <p>The <strong>Net NPAs to Net Advances Ratio</strong> is higher in the case of <strong>IND Bank</strong> as compared to other public sector banks.</p>

      <p>This indicates that there is a risk that the bank may not have made the required provisions in accordance with RBI guidelines.</p>

      <p>A higher Net NPAs to Net Advances Ratio indicates the probability and risk of <strong>under-provisioning</strong>.</p>

      <p>Keeping in view the above, audit procedures have to be tailored towards the examination and verification of this crucial area.</p>
    `
  },
  {
    question_id: "AUD_MTPMAR24_3C",
    source: "ICAI Mock Test Paper - Series I, March 2024",
    chapter_name: "Audit under Fiscal Laws – GST",
    placement: 3,
    marks: 5,
    question_html: `
      <p> Mr. Mohit is a Chartered Accountant in practice. He has recently been appointed as the GST Auditor of Smart India Private Limited under the provisions of the Goods and Services Tax Act.</p>

      <p><strong>Briefly explain the duties of the auditor while conducting audit under the GST law.</strong></p>
    `,
    solution_html: `
      <strong>Solution:</strong><br><br>

      <p>The duties of the auditor under the Goods and Services Tax (GST) law include the following:</p>

      <ol type="1">
        <li>
          The auditor should conduct the audit in accordance with the provisions of the GST law and the relevant Standards on Auditing, wherever applicable.
        </li>

        <li>
          The auditor should examine the books of account and other relevant records maintained by the registered person.
        </li>

        <li>
          The auditor should verify whether the particulars furnished in the returns are true and correct.
        </li>

        <li>
          The auditor should verify whether the registered person has complied with the provisions of the GST Act and the Rules made thereunder.
        </li>

        <li>
          The auditor should examine whether the value of supplies, taxes paid, input tax credit claimed, refund claimed and other relevant particulars are correctly reflected in the books of account and returns.
        </li>

        <li>
          The auditor should report the observations and discrepancies noticed during the audit and certify the prescribed reconciliation statement, wherever applicable.
        </li>

        <li>
          The auditor should ensure that the audit report is complete, accurate and submitted within the time prescribed under the GST law.
        </li>
      </ol>
    `
  },
  {
    question_id: "AAA_MTPMAR24_4A",
    source: "ICAI MTP March 2024",
    chapter_name: "SA 560 - Subsequent Events & SA 706 - Emphasis of Matter Paragraphs",
    placement: 4,
    marks: 5,
    question_html: `
      <h3>Question 4(a)</h3>
      ...
      <p>Mr. Rishabh discussed the said matter with the management, and it was determined to amend the financial statements for F.Y. 2022-23. Further, Mr. Rishabh inquired how the management intended to address the said matter in the financial statements to which he was told that the said matter was going to be disclosed as a <strong>“Contingent Liability for a Court case”</strong> to the foot note in the balance sheet with no additional disclosures.</p>

      <p>The management told Mr. Rishabh that such disclosure was enough as he would be further going to provide description of the said court case and its outcome in the <strong>‘Emphasis of Matter’</strong> paragraph in his amended audit report.</p>

      <p>In the context of aforesaid case-scenario, please answer the following questions:</p>

      <ol type="i">
      <li>Whether Mr. Rishabh on behalf of SRM & Co., has properly adhered to his responsibilities in accordance with SA 560, on becoming aware of the court case filed against Rare (P) Ltd.?</li>

      <li>Whether the contention of management of Rare (P) Ltd. is valid with respect to the disclosure of court case in the financial statements?</li>
      </ol>
    `,
    solution_html: `
      <h3>Answer</h3>
      ...
      <p>As per <strong>SA 560, "Subsequent Events"</strong>, the auditor has no obligation to perform any audit procedures regarding the financial statements after the date of the auditor’s report. However, when, after the date of the auditor’s report but before the date the financial statements are issued, a fact becomes known to the auditor that, had it been known to the auditor at the date of the auditor’s report, may have caused the auditor to amend the auditor’s report, the auditor shall:</p>

      <ol>
      <li>Discuss the matter with management and, where appropriate, those charged with governance.</li>

      <li>Determine whether the financial statements need amendment and, if so,</li>

      <li>Inquire how management intends to address the matter in the financial statements.</li>
      </ol>

      <p>In the given case, on becoming aware of the court case filed against Rare (P) Ltd., Mr. Rishabh discussed the said matter with the management and determined to amend the financial statements. Also, he inquired how the management intended to address the said matter in the financial statements.</p>

      <p><strong>Thus, it can be said that Mr. Rishabh has properly adhered to his responsibilities in accordance with SA 560, on becoming aware of the court case filed against Rare (P) Ltd.</strong></p>

      <br>

      <p><strong>(ii)</strong></p>

      <p>As per <strong>SA 706, "Emphasis of Matter Paragraphs and Other Matter Paragraphs in the Independent Auditor’s Report"</strong>, an Emphasis of Matter paragraph is not a substitute for:</p>

      <ol type="a">
      <li>A modified opinion in accordance with SA 705 (Revised) when required by the circumstances of a specific audit engagement;</li>
      ...
      <li>Reporting in accordance with SA 570 (Revised) when a material uncertainty exists relating to events or conditions that may cast significant doubt on an entity’s ability to continue as a going concern.</li>
      </ol>

      <p>In the given case, the management of Rare (P) Ltd. has presumed that as the auditor was going to provide a description of the said court case and its outcome in the <strong>‘Emphasis of Matter’</strong> paragraph in his amended audit report, there was no further need for it to provide additional disclosures about the court case in the financial statements.</p>

      <p><strong>The said contention of management of Rare (P) Ltd. is not valid as an Emphasis of Matter paragraph cannot be used as a substitute for disclosures required to be made in the financial statements as per the applicable financial reporting framework or that is otherwise necessary to achieve fair presentation, which is the responsibility of the management.</strong></p>
    `
  },
  {
    question_id: "AAA_MTPMAR24_4B",
    source: "ICAI MTP March 2024",
    ...
    question_html: `
      ...
      <p>The company had submitted inputs on draft Digital Personal Data Protection Bill to concerned Ministry during year 2022-23. It had also submitted to one of the industry chambers during the same year certain key inputs on leveraging India’s digital public infrastructure for creating solutions by banks and fintechs together as its taskforce member on the subject.</p>

      <p>Considering the above, discuss how above information would likely be disclosed by company in <strong>“Principle-wise performance disclosures”</strong> as part of BRSR for year 2022-23?</p>

      <p>Whether information discussed above would require to be disclosed mandatorily?</p>
    `,
    solution_html: `
      <h3>Answer</h3>

      <p>The given case highlights that <strong>CTO Limited</strong>, engaged in Fintech business, is a member of Chamber of Commerce/associations. Such information needs to be disclosed under <strong>Principle 7</strong> of Principle-wise Performance Disclosures.</p>

      <p><strong>Principle 7</strong> recognizes that businesses, when engaging in influencing public and regulatory policy, operate within the framework of statutory and legislative policies of the governing authority. Collective associations such as trade groups and industry chambers have to be utilized when moving ahead with policy advocacy and formulation.</p>

      <p>The information under each principle is to be disclosed under <strong>Essential Indicators (mandatory disclosures)</strong> and <strong>Leadership Indicators (optional disclosures)</strong>.</p>

      <ul>
      <li>Information relating to membership of Chamber/associations is in the nature of <strong>Essential Indicators</strong> and requires <strong>mandatory disclosures</strong>.</li>

      <li>Information relating to inputs provided by company to the Ministry on a legislative bill and inputs provided to one of the prominent chambers on leveraging India’s digital public infrastructure for creating solutions by banks and Fintechs together as a taskforce member on the subject are in the nature of <strong>Leadership Indicators</strong> and are <strong>optional disclosures</strong>.</li>
      </ul>
    `
  },
  {
    question_id: "AAA_MTPMAR24_4C",
    source: "ICAI MTP March 2024",
    ...
    question_html: `
      ...
      <p>Justify the type of opinion which CA. Navya should give in such a situation. Also, Draft an appropriate <strong>Opinion paragraph</strong> and <strong>Basis of Opinion paragraph</strong>.</p>
    `,
    solution_html: `
      <h3>Answer</h3>

      <p>In the present case, with respect to the loans and advances of <strong>₹ 75 Lacs</strong> given to Hariharan Pvt. Ltd., the Company has not furnished any agreement to CA. Navya. In the absence of such an agreement, CA. Navya is unable to verify the terms of repayment, chargeability of interest and other terms.</p>

      <p>For an auditor, while verifying any loans and advances, one of the most important audit evidence is the loan agreement. Therefore, the absence of such a document in the present case, tantamount to a material misstatement in the financial statements of the company. However, the inability of CA. Navya to obtain such audit evidence is though material but not pervasive so as to require him to give a disclaimer of opinion.</p>

      <p><strong>Thus, in the present case, CA. Navya should give a Qualified Opinion.</strong></p>

      <h4>Qualified Opinion</h4>

      <p>In our opinion and to the best of our information and according to the explanations given to us, <strong>except for the effects of the matter described in the Basis for Qualified Opinion section of our report</strong>, the financial statements of Lakshay Ltd. give a true and fair view in conformity with the accounting principles generally accepted in India, of the state of affairs of the Company as on 31.03.2023 and profit/loss for the year ended on that date.</p>

      <h4>Basis for Qualified Opinion</h4>

      <p>The Company is unable to furnish the loan agreement with respect to loans and advances of <strong>₹ 75 Lacs</strong> given to Hariharan Pvt. Ltd. Consequently, in the absence of such an agreement, we are unable to verify the terms of repayment, chargeability of interest and other terms.</p>
    `
  },
  {
    question_id: "AAA_MTPMAR24_5A",
    source: "ICAI MTP March 2024",
    chapter_name: "SA 720 - The Auditor's Responsibilities Relating to Other Information",
    placement: 5,
    marks: 5,
    question_html: `
      <h3>Question 5(a)</h3>
      ...
      <p>The audit in-charge was going through the draft annual report and observed that the company has included an item in its Annual Report indicating a downward trend in market prices of key commodities/raw material as compared to previous year. However, the actual profit margin of the company as reported in financial statements has gone in the reverse direction.</p>

      <p>The Audit Manager discussed this issue with a partner of the firm who in reply said that auditors are not covered with such disclosures made by the management in its annual report, it being the responsibility of the management.</p>

      <p>Do you think that the partner is correct in his approach on this issue? Discuss with reference to relevant Standard on Auditing the Auditor's duties with regard to reporting.</p>
    `,
    solution_html: `
      <h3>Answer</h3>

      <p><strong>Responding When the Auditor Concludes That a Material Misstatement of the Other Information Exists:</strong> As per <strong>SA 720, "The Auditor's Responsibilities Relating to Other Information"</strong>, descriptions of trends in market prices of key commodities or raw materials is an example of amounts or other items that may be included in the other information.</p>
      ...
      <p><strong>Auditor's duties with regard to reporting in the given case are as follows:</strong></p>

      <p>As per <strong>SA 720, "The Auditor's Responsibilities Relating to Other Information"</strong>, if the auditor concludes that a material misstatement of the other information exists, the auditor shall request management to correct the other information. If management:</p>

      <ol type="i">
      <li>Agrees to make the correction, the auditor shall determine that the correction has been made; or</li>

      <li>Refuses to make the correction, the auditor shall communicate the matter with those charged with governance and request that the correction be made.</li>
      </ol>

      <p><strong>The contention of the partner of the firm that auditors are not concerned with such disclosures made by the management in its annual report is incorrect.</strong></p>
    `
  },
  {
    question_id: "AAA_MTPMAR24_5B",
    source: "ICAI MTP March 2024",
    chapter_name: "Performance Audit by C&AG – Direct Benefit Transfer (DBT)",
    placement: 5,
    marks: 5,
    question_html: `
      <h3>Question 5(b)</h3>
      ...
      <p>The office of C & AG of India is likely to undertake a performance audit for a block of years in a state of some selected social security pension schemes and scholarship schemes under DBT.</p>

      <p>What are likely to be objectives of such performance audit? Explaining meaning of <strong>“audit criteria”</strong>, discuss how these can be determined in above case.</p>
    `,
    solution_html: `
      <h3>Answer</h3>

      <p>The likely objectives of performance audit to be conducted by office of <strong>C & AG of India</strong> of some selected social security pension schemes and scholarship schemes in a state could be:</p>

      <ul>
      <li>Whether proper planning and process were in place to capture data of beneficiaries under the above schemes.</li>

      <li>Whether necessary steps were taken for implementation of DBT like preventing delay in payments to the intended beneficiaries and pilferage and duplication.</li>

      <li>Whether the infrastructure, organization and management of DBT were adequate and effective.</li>
      </ul>

      <p><strong>Audit criteria</strong> are standards used to determine whether a programme meets or exceeds expectations. It provides a context for understanding the results of the audit. Audit criteria are reasonable and attainable standards of performance against which economy, efficiency and effectiveness of programmes and activities can be assessed.</p>

      <p>In the above situation, various documents issued by Government of India and State Government like circulars, instructions, Standard Operating Procedure (SOP) manuals, guidelines of schemes on identification and authentication of beneficiaries, etc., and general management and subject matter literature can be used to determine the <strong>audit criteria</strong>.</p>
    `
  },
  {
    question_id: "AAA_MTPMAR24_5C",
    source: "ICAI MTP March 2024",
    chapter_name: "Code of Ethics – GeM (Government e-Marketplace)",
    placement: 5,
    marks: 4,
    question_html: `
      <h3>Question 5(c)</h3>
      ...
      <p>Whether a firm of Chartered Accountants can register on GeM portal for rendering professional services to Government departments?</p>
    `,
    solution_html: `
      <h3>Answer</h3>

      <p>As per provisions of <strong>Council Guidelines for Advertisement, 2008</strong>, it is not permissible for members to list themselves with online application based service provider Aggregators, wherein other categories like businessmen, technicians, maintenance workers, event organizers etc. are also listed.</p>

      <p>Further, as per explanation to <strong>Clause (6) of Part I of First Schedule to the Chartered Accountants Act, 1949</strong>, the Government departments, Government Companies/ corporations, courts, cooperative societies and banks and other similar institutions prepare panels of Chartered Accountants for allotment of audit and other professional work. Where the existence of such a panel is within the knowledge of a member, he is free to write to the concerned organization with a request to place his name on the panel. However, it would not be proper for the Chartered Accountant to make roving enquiries by applying to any such organization for having his name included in any such panel. It is permissible to quote fees on enquiries being received or respond to tenders from the organizations requiring professional services, which maintain such panel.</p>

      <p>Getting registered on <strong>GeM Portal</strong> by members does not appear to amount either to empanelment or listing on Aggregator. In Aggregator, it is the third party which is operating, and not the client itself. GeM is operated by the client itself.</p>

      <p>It is a pre-requirement of rendering professional services to the Government departments, as stipulated by them, and be considered as ancillary requirement to providing services to the Government departments. Firms of Chartered Accountants are permitted to register on GeM Portal for rendering professional services as there is no violation of the ethical norms of the Institute in registering on the GeM Portal and such registration on the Portal is a pre-requirement for providing services to the Government departments/organisations.</p>

      <p>However, firms should ensure compliance with the <strong>Tender Guidelines</strong> issued by the Institute while participating in tender or bid floated through GeM Portal. The ICAI has made an announcement in relation to the above.</p>
    `
  },
  {
    question_id: "AAA_MTPMAR24_6A",
    source: "ICAI MTP March 2024",
    chapter_name: "SA 810 – Engagements to Report on Summary Financial Statements / SRE 2400 – Engagements to Review Historical Financial Statements",
    placement: 6,
    marks: 5,
    question_html: `
      <h3>Question 6(a)</h3>
      ...
      <p>If summary financial statements are not a fair summary of the audited financial statements, in accordance with the applied criteria, and management does not agree to make the necessary changes, what are implications for auditor’s opinion on summary financial statements?</p>

      <p><strong>(5 Marks)</strong></p>

      <p><strong>Or</strong></p>

      <p>In a review engagement performed under SRE 2400, practitioner relies mainly on certain procedures. Naming such procedures, discuss importance of these procedures in a review engagement.</p>

      <p>Practitioner’s report containing outcome of review engagement in form of “conclusion” also contains a description of a review of financial statements and its limitations. Which statements in this respect are to be included in practitioner’s report in accordance with SRE 2400?</p>
    ...
    solution_html: `
      ...
      <p>When the auditor’s report on the audited financial statements contains a qualified opinion, but the auditor is satisfied that the summary financial statements are consistent, in all material respects, with or are a fair summary of the audited financial statements, in accordance with the applied criteria, the auditor’s report on the summary financial statements shall, in addition to the elements of auditor’s report on summary financial statements described in SA 810:-</p>

      <p> State that the auditor’s report on the audited financial statements contains a qualified opinion and</p>

      <p> Describe:</p>

      <ol type="i">
      <li>The basis for the qualified opinion on the audited financial statements, and that qualified opinion; and</li>
      <li>The effect thereof on the summary financial statements, if any.</li>
      </ol>

      <p>If the summary financial statements are not consistent, in all material respects, with or are not a fair summary of the audited financial statements, in accordance with the applied criteria, and management does not agree to make the necessary changes, the auditor shall express an <strong>adverse opinion</strong> on the summary financial statements.</p>

      <br>

      <p><strong>Or</strong></p>

      <p>In a review engagement performed under <strong>SRE 2400</strong>, the practitioner performs primarily <strong>inquiry and analytical procedures</strong> to obtain sufficient appropriate evidence as the basis for a conclusion on the financial statements as a whole expressed in accordance with the requirements of SRE 2400.</p>

      <p>In a review engagement, evidence obtained through inquiry is often the principal source of evidence about management intent. Application of professional skepticism in evaluating responses provided by management is important to enable the practitioner to evaluate whether there are any matters that would cause the practitioner to believe that the financial statements may be materially misstated. Performing inquiry procedures also assists the practitioner in obtaining or updating the practitioner’s understanding of the entity and its environment, to be able to identify areas where material misstatements are likely to arise in the financial statements.</p>

      <p>In a review of financial statements, performing analytical procedures assists the practitioner in:</p>

      <ul>
      <li>Obtaining or updating the practitioner’s understanding of the entity and its environment, including to be able to identify areas where material misstatements are likely to arise in the financial statements.</li>

      <li>Identifying inconsistencies or variances from expected trends, values or norms in the financial statements such as the level of congruence of the financial statements with key data, including key performance indicators.</li>

      <li>Providing corroborative evidence in relation to other inquiry or analytical procedures already performed.</li>

      <li>Serving as additional procedures when the practitioner becomes aware of matters that cause the practitioner to believe that the financial statements may be materially misstated. An example of such an additional procedure is a comparative analysis of monthly revenue and cost figures across profit centers, branches or other components of the entity, to provide evidence about financial information contained in line items or disclosures contained in the financial statements.</li>
      </ul>

      <p>In a review engagement, practitioner’s report contains a description of a review of financial statements and its limitations, and the following statements in this respect:</p>

      <ol type="i">
      <li>A review engagement under this SRE is a limited assurance engagement.</li>

      <li>The practitioner performs procedures, primarily consisting of making inquiries of management and others within the entity, as appropriate, and applying analytical procedures, and evaluates the evidence obtained.</li>

      <li>The procedures performed in a review are substantially less than those performed in an audit conducted in accordance with Standards on Auditing (SAs), and, accordingly, the practitioner does not express an audit opinion on the financial statements.</li>
      </ol>
    `
  },
  {
    question_id: "AAA_MTPMAR24_6B",
    source: "ICAI MTP March 2024",
    chapter_name: "Code of Ethics – Clause 11 of Part I of First Schedule to the Chartered Accountants Act, 1949",
    placement: 6,
    marks: 5,
    question_html: `
      <h3>Question 6(b)</h3>
      ...
      <p>During relevant year for which information is being sought for by PDC, CA. Z has transacted in futures and options derivatives (equity) and has reflected income from such transactions in his return of income as <strong>“Business Income”.</strong> Analyse the above situation with reference to the provisions of the Chartered Accountants Act, 1949.</p>

      <p>Would it make any difference if CA. Z had earned income from transacting in currency derivatives and commodity derivatives?</p>
    ...
    solution_html: `
      ...
      <p><strong>Clause 11 of Part I of First Schedule to the Chartered Accountants Act, 1949</strong> states that a Chartered Accountant in practice shall be deemed to be guilty of professional misconduct, if he engages in any business or occupation other than the profession of Chartered Accountants unless permitted by the Council so to engage.</p>

      <p>Provided that nothing contained herein shall disentitle a Chartered Accountant from being a director of a Company, (not being a managing director or a whole time director), unless he or any of his partners is interested in such company as an auditor.</p>

      <p>Ethical Standards Board of ICAI has announced that it is permissible for a member in practice to engage in derivative transactions in his personal capacity but not in professional capacity i.e. for clients. Such engagements in derivatives are not violative of provisions of <strong>Clause 11 of Part I of First Schedule to the Chartered Accountants Act, 1949.</strong></p>

      <p>Further, members are allowed to transact in equity and currency derivatives. There is no requirement to take permission of Council in this matter.</p>

      <p>Therefore, there is no difference if CA. Z had earned income from currency derivatives.</p>

      <p>However, in accordance with announcement of Ethical Standards Board of ICAI, it is not permissible for members in practice to transact in commodity derivative transactions. In such a case, CA. Z would be held guilty of professional misconduct for engaging in business other than profession of Chartered Accountancy.</p>
    `
  },
  {
    question_id: "AAA_MTPMAR24_6C",
    source: "ICAI MTP March 2024",
    chapter_name: "Forensic Accounting and Investigation",
    placement: 6,
    marks: 4,
    question_html: `
      <h3>Question 6(c)</h3>
      ...
      <p>The company operates in an electronic environment. While performing engagement, his team has gathered evidence from electronic records in Enterprise Resource Planning system (ERP), messages in company’s e-mail system and also from system logs and audit trails generated by company’s computer systems. However, while doing so, team has failed to take care of aspects such as keeping record of each person in team gathering relevant evidence, date and time of collection and storage of such evidence.</p>

      <p>What implications it may have on forensic accounting engagement as such?</p>
    ...
    solution_html: `
      ...
      <p>Forensic accounting engagement involves a detailed examination of all transactions and balances relevant to the mandate so that evidence gathered is suitable in a Court of Law i.e. in compliance with legal requirements where it can be challenged through cross-examination by the defending party.</p>

      <p>It is important that the team is skilled in collecting evidence that can be used in a court case, keeping a clear <strong>chain of custody</strong> till the evidence is presented in Court. If there are gaps in the chain of custody, then the evidence may be challenged in Court or even become inadmissible.</p>

      <p>In the given case, the team has failed to keep record of matters such as persons gathering relevant evidence, date and time of collection and storage of evidence. Therefore, the team has failed to maintain the <strong>chain of custody</strong>.</p>

      <p>It can, therefore, defeat the objective of the forensic accounting engagement as the evidence may be challenged in Court of Law by the defending parties and may become inadmissible.</p>
    `
  },
  {
    "question_id": "AUD_MTPAPR24II_Q1A",
    "source": "ICAI Mock Test Paper - Series II, April 2024",
    "chapter_name": "Consideration of Laws and Regulations (SA 250) & Going Concern (SA 570)",
    "placement": 1,
    "marks": 5,
    "question_html": `
      <p> Nandini Ltd., a chemical manufacturing company having its factory located at Kanawali Village, for the year 2022-23 appointed Vasu & Co. as their statutory auditors. During the course of the audit, Vasu & Co. identified that Nandini Ltd. received a show cause notice from the National Green Tribunal based on the investigation performed by the regional forest department for violating environmental laws.</p>
      <p>Upon gathering a further understanding of the said matter, it was identified that Nandini Ltd. was dumping toxic solid waste, without treating it, on the nearby grounds, and because of this, the nearby water bodies were getting polluted. Based on the preliminary investigation performed by the regional forest department under the directions of the National Green Tribunal, it was identified that these practices were carried out since 2009 and a lot of damage has been done to the environment by Nandini Ltd. A show cause notice was already issued to Nandini Ltd. by the National Green Tribunal for levying the penalty of an amount of ₹700 crore.</p>
      <p>The unaudited profit for the financial year 2022-23 of Nandini Ltd. was ₹49 crore and the unaudited turnover was ₹120 crore. Upon inquiry it was identified that Nandini Ltd. has disclosed this matter in the financial statements by way of footnote, the extract of which is provided below:</p>
      <p><em>“The company has received a show cause notice from the National Green Tribunal for some potential violation of environmental laws and the company’s legal department has assessed and found that the judgment would be in favour of the company. Accordingly, no provision has been created for such notices.”</em></p>
    ...
    "solution_html": `
      ...
      <ul>
        ...
        <li>The auditor must perform specific procedures, including inquiring of management/TCWG and inspecting correspondence with relevant regulatory authorities.</li>
        <li>Under <strong>Section 143(3)(j)</strong> read with <strong>Rule 11(a) of the Companies (Audit and Auditors) Rules, 2014</strong>, the auditor is required to report whether the company has disclosed the impact, if any, of pending litigations on its financial position in its financial statement.</li>
      </ul>
      <p><strong>2. Going Concern Assessment (SA 570):</strong></p>
      <ul>
        <li>As per <strong>SA 570</strong>, <em>"Going Concern"</em>, if a material uncertainty exists that may cast significant doubt on the entity's ability to continue as a going concern, the auditor must determine if the financial statements adequately disclose the principal events/conditions and clearly state that a material uncertainty exists.</li>
        <li>If adequate disclosure is not made, the auditor shall express a <strong>Qualified or Adverse opinion</strong> as appropriate (in accordance with SA 705).</li>
      </ul>
      <p><strong>Conclusion & Reporting Duty in the Given Case:</strong></p>
      <ul>
        <li>Nandini Ltd. received a show cause notice of <strong>₹700 crore</strong>, which vastly exceeds its net profit (₹49 crore) and turnover (₹120 crore). An unfavorable order will severely threaten the entity's ability to continue as a going concern.</li>
        <li>The simple footnote disclosure provided by management is inadequate as it fails to disclose the material uncertainty casting significant doubt on the going concern status.</li>
        <li>Therefore, Vasu & Co. should report this matter under the <strong>"Material Uncertainty Related to Going Concern"</strong> paragraph (as per SA 570) and under clause (j) of section 143(3). Furthermore, due to the highly pervasive nature and severe impact of the deficiency, the auditor is required to issue an <strong>Adverse Opinion</strong> as per <strong>SA 705</strong>.</li>
      </ul>
    `
  },
  {
    "question_id": "AUD_MTPAPR24II_Q1B",
    "source": "ICAI Mock Test Paper - Series II, April 2024",
    "chapter_name": "Quality Control for an Audit of Financial Statements (SA 220)",
    "placement": 2,
    "marks": 4,
    "question_html": `
      <p> Pine & Associates is the statutory auditor of BB Ltd., a listed company and started its operations 6 years ago. The fieldwork during the audit of the financial statements of the company for the year ended 31st March, 2023 was completed on 1st May, 2023. The auditor’s report was dated 15th May, 2023. During the documentation review of the engagement, it was observed that the engagement quality control review was completed on 18th May, 2023. The engagement partner had completed his reviews in entirety by 12th May, 2023. Comment.</p>
    `,
    "solution_html": `
      ...
      <ul>
        <li>As per <strong>SA 220</strong>, <em>"Quality Control for an Audit of Financial Statements"</em>, for audits of financial statements of listed entities, the engagement partner shall:
          <ul>
            <li>Determine that an engagement quality control reviewer (EQCR) has been appointed;</li>
            <li>Discuss significant matters arising during the audit engagement with the EQCR; and</li>
            <li><strong>Not date the auditor's report until the completion of the engagement quality control review.</strong></li>
          </ul>
        </li>
        <li>Furthermore, <strong>SA 700</strong>, <em>"Forming an Opinion and Reporting on Financial Statements"</em>, mandates that the auditor's report shall not be dated earlier than the date on which the auditor has obtained sufficient appropriate audit evidence on which to base the opinion. For listed entities, the EQCR assists in ensuring that sufficient appropriate evidence has been gathered.</li>
        <li>Conducting the EQCR in a timely manner allows significant matters to be promptly resolved on or before the date of the auditor's report.</li>
      </ul>
      <p><strong>Analysis & Conclusion:</strong></p>
      <ul>
        <li>In the given scenario, Pine & Associates dated the auditor's report on <strong>15th May, 2023</strong>, whereas the engagement quality control review was finalized later, on <strong>18th May, 2023</strong>.</li>
        <li>Dating the auditor's report before the formal completion of the engagement quality control review is a direct violation of the mandatory requirements of SA 220. Thus, the actions of the engagement partner are <strong>not correct</strong>.</li>
      </ul>
    `
  },
  {
    "question_id": "AUD_MTPAPR24II_Q1C",
    "source": "ICAI Mock Test Paper - Series II, April 2024",
    "chapter_name": "The Auditor's Responsibilities Relating to Fraud (SA 240)",
    "placement": 3,
    "marks": 5,
    "question_html": `
      <p> Aditya Ltd. was engaged in the business of owning and managing hotels and resorts, selling tourism packages and performing airline bookings for corporate and individuals. It appointed Sanjay & Co. as its statutory auditor for the financial year 2022-23. While planning the audit, the audit team decided that the risk of improper revenue recognition from hotel business should not be treated as a fraud risk. This conclusion was based on the assessment of earlier years, wherein no fraud was identified in revenue recorded from such business.</p>
      <p>While testing the internal financial controls over the process of revenue recognition, it was identified that the controls are not properly designed to mitigate the risk of fraud and risk of improper revenue recognition. As a result, the audit team decided to perform additional substantive testing. However, the audit team still arrived at the conclusion that there is no risk of fraud in revenue recognition.</p>
      <p>During the course of substantive testing, it was identified that the management did not account for revenue received from corporate hotel bookings amounting to ₹43 crore. These amounts were partially received in the company’s bank accounts and partially received in the CFO’s personal account. The amounts received in the bank account of the company were disclosed as advances received against future bookings.</p>
    ...
    "solution_html": `
      ...
      <ul>
        ...
        <li>While this presumption can occasionally be rebutted (e.g., a simple, single-source stream like leasehold revenue from a single property), complex streams or environments with a <strong>lack of internal controls</strong> create a high probability of fraud risk that cannot be ignored. Past history alone cannot justify completely dismissing fraud risk in the current period.</li>
      </ul>
      <p><strong>2. Response to Assessed Risks (SA 330):</strong></p>
      <ul>
        <li>Risk assessment is a continuous, dynamic process. When the audit team identified that internal controls over revenue recognition were <strong>not properly designed</strong> to mitigate fraud, they should have immediately updated their risk model, treated improper revenue recognition as a <strong>significant risk</strong>, and maintained a high level of professional skepticism. Rebutting fraud risk under these deficient control conditions was incorrect.</li>
      </ul>
      <p><strong>3. Statutory Reporting Obligation Under Section 143(12) of Companies Act, 2013:</strong></p>
      <ul>
        <li>During substantive testing, a structural fraud of <strong>₹43 crore</strong> was uncovered involving revenue siphoned into the CFO's personal account and misclassified as advances.</li>
        <li>As per <strong>Section 143(12)</strong> of the Companies Act, 2013, if an auditor in the course of the performance of his duties has reason to believe that an offence of fraud involving an amount of <strong>₹1 crore or above</strong> is being or has been committed against the company by its officers or employees, the auditor must report the matter to the <strong>Central Government</strong> (Ministry of Corporate Affairs) within the prescribed time frame and format (Form ADT-4).</li>
      </ul>
    `
  },
  {
    "question_id": "AUD_MTPAPR24II_Q2A",
    "source": "ICAI Mock Test Paper - Series II, April 2024",
    "chapter_name": "Materiality in Planning and Performing an Audit (SA 320)",
    "placement": 4,
    "marks": 5,
    "question_html": `
      <p> Suneel was appointed as the auditor of PCM Ltd. for the financial year 2022-23. During the course of planning for the audit, CA. Suneel intends to apply the concept of materiality for the financial statements as a whole. Please guide him with respect to the factors that may affect the identification of an appropriate benchmark for this purpose.</p>
      <p>What benchmark should be adopted by CA. Suneel, if PCM Ltd. is engaged in:</p>
      <p><strong>(i)</strong> the manufacture and sale of air conditioners and is having regular profits.</p>
    ...
    "solution_html": `
      ...
      <ul>
        <li><strong>Elements of the financial statements:</strong> Assets, liabilities, equity, revenue, expenses.</li>
        <li><strong>User attention areas:</strong> Items on which users tend to focus (e.g., profit for commercial users, net assets for debt-financed entities).</li>
        <li><strong>Nature of the entity:</strong> Where the entity is in its life cycle, its industry, and the macroeconomic environment.</li>
        <li><strong>Ownership and financing structure:</strong> If financed solely by debt, users focus more on assets and security claims rather than earnings.</li>
        <li><strong>Relative volatility:</strong> The benchmark should be stable and not prone to extreme short-term swings.</li>
      </ul>
      <p><strong>Application to the Specific Scenarios of PCM Ltd.:</strong></p>
      <ul>
        <li><strong>Scenario (i) - Manufacture & Sale of ACs with Regular Profits:</strong> For a stable commercial business with consistent profitability, the attention of users is focused heavily on financial performance. Therefore, <strong>Profit Before Tax (PBT)</strong> or <strong>Earnings</strong> is the most appropriate benchmark.</li>
        <li><strong>Scenario (ii) - Construction of Large Infra Projects with Recent Pandemic Losses:</strong> Profit before tax is highly volatile or unrepresentative due to loss-making cycles. Therefore, alternative stable bases like <strong>Total Revenue</strong> or <strong>Gross Profit</strong> should be considered. For entities delivering long-term public utility infrastructure projects, <strong>Total Assets</strong> or <strong>Net/Total Project Cost (expenditure basis)</strong> may also serve as valid benchmarks.</li>
      </ul>
    `
  },
  {
    "question_id": "AUD_MTPAPR24II_Q2B",
    "source": "ICAI Mock Test Paper - Series II, April 2024",
    "chapter_name": "Audit in an Automated Environment",
    "placement": 5,
    "marks": 4,
    "question_html": `
      <p> Gravity Ltd. is a medium-sized manufacturing company that is planning to implement a new digital system to streamline its production processes and improve efficiency. The company appointed Mr. Ravi as IT manager. However, he is aware that merging technologies can bring significant benefits but also pose various risks to the organization. In this context, he needs to identify examples of technological risks associated with the implementation of the new digital system and the control considerations necessary to mitigate these risks effectively.</p>
    `,
    "solution_html": `
      ...
      <ul>
        ...
        <li><strong>Unauthorized Access:</strong> Access controls failing, leading to destruction, tampering, or malicious manipulation of data, or the creation of fraudulent/non-existent transactions.</li>
        <li><strong>Privilege Abuse & Lack of Segregation:</strong> IT personnel acquiring overriding access rights beyond their assigned operational role, breaking internal checks.</li>
        <li><strong>Unauthorized Master Data Changes:</strong> System gaps letting personnel modify core master fields (e.g., prices, vendor details) without tracking.</li>
        <li><strong>Program Overrides:</strong> Unauthorized or poorly documented adjustments made directly to system code or foundational logic.</li>
        <li><strong>Data Loss/System Downtime:</strong> Structural failures causing permanent data corruption or general operational blackout.</li>
        <li><strong>Third-Party/Vendor Risks:</strong> Security exposures introduced via integrations with external digital service providers.</li>
        <li><strong>Cybersecurity Threats:</strong> Direct targeted external security breaches, hacking, or ransomware exposure.</li>
      </ul>
      <p><strong>Control Considerations to Mitigate Risks effectively:</strong></p>
      <ol>
        <li><strong>Holistic System Mapping:</strong> Management and auditors must comprehensively evaluate the digital ecosystem and chart how transactions are initiated, processed, and recorded under the new tech layer.</li>
        <li><strong>Differentiated IT Risk Analysis:</strong> Recognize how automated system risks diverge from older legacy structures (e.g., tracking automated background processing batches vs manual interventions).</li>
        <li><strong>Digital Upskilling and Specialist Inclusion:</strong> Engaging cybersecurity and IT audit engineers to validate the operational design and security strength of parameters and logical controls.</li>
      </ol>
    `
  },
  {
    "question_id": "AUD_MTPAPR24II_Q2C",
    "source": "ICAI Mock Test Paper - Series II, April 2024",
    "chapter_name": "Professional Ethics & CA Act, 1949",
    "placement": 6,
    "marks": 5,
    "question_html": `
      <p> Mr. S is a practising Chartered Accountant based out of Chennai. During the weekends, he involved himself in equity research and used to advise his friends, relatives and other known people who are not his clients. Apart from this, he was also involved as a paper-setter for Accountancy subject in the school in which he studied. He also owned agricultural land and was doing agriculture during his free time. During the year 20X1, heavy losses were incurred in agricultural activity due to natural calamities and misfortune, and he lost almost all of his wealth and became undischarged insolvent. After a few court hearings, finally, in the year 20X3, he was declared discharged insolvent and obtained a certificate from the court stating that his insolvency was caused by misfortune without any misconduct on his part. You are required to comment on the above situation with reference to the Chartered Accountants Act, 1949 and Schedules thereto.</p>
    `,
    "solution_html": `
      ...
      <ul>
        <li>Per the rulings of the Ethical Standards Board (ESB) of ICAI, a practicing Chartered Accountant is permitted to act as an equity research adviser and guide personal contacts. However, they are strictly prohibited from publishing retail investment reports to the general public, as it would amount to engaging in a separate business/occupation.</li>
        <li>Since Mr. S limited his advice to friends and relatives and did not issue a retail report, this does not attract professional misconduct.</li>
      </ul>
      <p><strong>2. Paper Setting and Agricultural Activities:</strong></p>
      <ul>
        <li><strong>Clause (11) of Part I of the First Schedule</strong> prohibits a CA in practice from engaging in any business or occupation other than the profession of Chartered Accountancy, unless permitted by the Council.</li>
        <li>However, under <strong>Regulation 190A</strong>, certain occupations are granted <em>"Permission Generally"</em>, where no explicit individual application is required. These include:
          <ul>
            <li>Acting as a paper-setter, head examiner, or moderator for any examination.</li>
            <li>Owning agricultural land and engaging in personal agricultural activities.</li>
          </ul>
        </li>
        <li>Hence, these dual activities do not constitute misconduct.</li>
      </ul>
      <p><strong>3. Insolvency Status & Disabilities under Section 8:</strong></p>
      <ul>
        <li><strong>Section 8(v)</strong> of the CA Act, 1949 states that a person's name cannot be entered or borne on the Register of Members if they are an undischarged insolvent.</li>
        <li><strong>Section 8(vi)</strong> adds that if they are a <em>discharged insolvent</em>, they remain disqualified <strong>unless</strong> they obtain a certificate from the court stating that their insolvency was caused by <strong>misfortune without any misconduct</strong> on their part.</li>
      </ul>
      <p><strong>Conclusion:</strong></p>
      <p>Since Mr. S successfully obtained the explicit court certificate confirming that his insolvency was strictly a result of natural misfortune and completely clear of any operational or ethical misconduct, he satisfies the protective criteria of Section 8(vi). He does not suffer a permanent bar, and his actions across all points are valid under the Act.</p>
    `
  },
  {
    ...
    "question_html": `
      ...
      <p><strong>Observation 1:</strong> The management had disclosed in the financials that, during the year, one of the warehouses of the Company was affected due to a major flood. As a result of the same, the Company had incurred some losses. But the management was of the view that it was not material.</p>
      <p><strong>Observation 2:</strong> Due to the flood, few records maintained by the Company with respect to a particular transaction was completely destroyed and there was no duplicate record maintained by the Company. However, those details were not pervasive, but material.</p>
    ...
    "solution_html": `
      ...
      <ul>
        ...
        <li>A catastrophe such as a major flood damaging operational infrastructure qualifies as a fundamental occurrence. Even if the immediate direct accounting losses are quantified as minor by management, the operational event carries significance.</li>
        <li><strong>Reporting Placement:</strong> BPMR and Associates should draw attention to management's footnote disclosure under a clear heading titled <strong>"Emphasis of Matter"</strong> immediately following the Basis for Opinion section.</li>
      </ul>
      <p><strong>2. Evaluation of Observation 2 (Destroyed Accounting Records):</strong></p>
      <ul>
        <li>As per <strong>SA 705</strong>, <em>"Modifications to the Opinion in the Independent Auditor's Report"</em>, if the auditor is unable to obtain sufficient appropriate audit evidence due to an unexpected limitation of scope (such as physical destruction of documentation), and the potential effects are determined to be <strong>material but not pervasive</strong>, the auditor must issue a modified opinion.</li>
        <li>An adverse or disclaimer is avoided because the issue is limited to a single transaction pocket (not pervasive), but clean certification is barred because it is material.</li>
        <li><strong>Reporting Placement:</strong> The firm must issue a <strong>"Qualified Opinion"</strong>. The rationale explaining the missing transaction trails must be described inside the <strong>"Basis for Qualified Opinion"</strong> section.</li>
      </ul>
    `
  },
  {
    ...
    "question_html": `
      ...
      <table border="1" cellpadding="5" cellspacing="0" style="border-collapse:collapse; text-align:left; max-width:500px;">
        <thead>
    ...
    "solution_html": `
      ...
      <ul>
        <li>Under RBI guidelines, a bank can only sell a non-performing asset to another bank/financial entity if the specific account <strong>has remained classified as an NPA in its books for at least 2 full financial years</strong>.</li>
        <li><strong>Evaluation of Assets in April 2023:</strong>
          <ul>
            <li><strong>Fin Pvt. Ltd.</strong> (NPA since 2019-20) &rarr; > 2 years &rarr; <strong>Eligible</strong></li>
            <li><strong>Book Store</strong> (NPA since 2018-19) &rarr; > 2 years &rarr; <strong>Eligible</strong></li>
            <li><strong>Fancy Corp.</strong> (NPA since 2017-18) &rarr; > 2 years &rarr; <strong>Eligible</strong></li>
            <li><strong>RSM and Associates</strong> (NPA since 2020-21) &rarr; Exactly 2 full years completed by March 2023 &rarr; <strong>Eligible</strong></li>
            <li><strong>Dairy Works</strong> (NPA since 2021-22) &rarr; Classified as NPA during 2021-22. As of April 2023, it has not completed the mandatory minimum tenure of 2 continuous financial years as an NPA. &rarr; <strong>NOT ELIGIBLE</strong>. The proposal to sell Dairy Works must be rejected.</li>
          </ul>
        </li>
      </ul>
      <p><strong>2. Other Critical Scrutiny Points for the Internal Auditor:</strong></p>
      <ul>
        <li><strong>Board Policy & Delegation:</strong> Confirm the sale originates from a structured policy formally written by the Board of Directors, outlining valuation models and delegation caps.</li>
        <li><strong>Without Recourse Basis:</strong> Ensure the transaction contract passes 100% of the operational, credit, and legal risks cleanly to the buying entity, leaving NRF Bank with zero residual exposure.</li>
        <li><strong>All-Cash / Upfront Basis:</strong> The entire finalized consideration value must be executed on a cash delivery base. Contingent or deferred installment pricing models are prohibited.</li>
        <li><strong>Accounting Treatment of Profits/Losses:</strong>
          <ul>
            <li>If the sale price is lower than the Net Book Value (NBV = Gross Book Value minus provisions held), the resulting deficit must be immediately charged to the current year's Profit & Loss Account.</li>
            <li>If sold above NBV, the surplus provision cannot be written back to P&L; it must be preserved and utilized to write off shortfalls/losses arising from the sale of other non-performing loans.</li>
          </ul>
        </li>
      </ul>
    `
  },
  {
    ...
    "solution_html": `
      ...
      <ul>
        ...
        <li>However, the ethical guidance issued by ICAI specifies that this right must be exercised in a highly dignified, professional manner. The representation letter should focus strictly on clarifying how he has discharged his audit duties independently and conscientiously during his tenure. It can also state a professional willingness to continue if reappointed.</li>
        <li>The representation <strong>must never be leveraged as a covert tool for self-advertisement, publicity, or canvassing for business</strong>.</li>
        <li>As per <strong>Clause (6) of Part I of the First Schedule to the Chartered Accountants Act, 1949</strong>, a Chartered Accountant in practice is deemed guilty of professional misconduct if he solicits clients or professional work either directly or indirectly by circular, advertisement, personal communication, or any other unauthorized means.</li>
      </ul>
      <p><strong>Analysis & Conclusion:</strong></p>
      <ul>
        <li>In this case, CA. Lucky included a detailed narrative highlighting his personal "contributions in strengthening the control procedures of the company."</li>
        <li>Detailing achievements in internal management controls goes beyond an objective defense of audit performance and effectively serves as an active promotion of his firm's capabilities to secure continuation. This amounts to soliciting professional work via the representation channel.</li>
        <li>Therefore, CA. Lucky will be held <strong>guilty of professional misconduct</strong> under Clause (6) of Part I of the First Schedule to the Chartered Accountants Act, 1949.</li>
      </ul>
    `
  },
  {
    ...
    "solution_html": `
      ...
      <ul>
        <li>As per <strong>SA 600</strong>, <em>"Using the Work of Another Auditor"</em>, a principal auditor formatting an opinion on consolidated statements is <strong>entitled to rely upon the work and finalized reports of the component auditors</strong>, provided they perform baseline review checks.</li>
        <li>The principal auditor can request questionnaires, discuss programmatic procedures, or outline core framework parameters with the component auditor. However, they <strong>do not possess a legal or professional mandate to demand a full re-audit</strong> of components already legally audited by a qualified practitioner, unless exceptional circumstances exist. Hence, this part of the contention is <strong>incorrect</strong>.</li>
      </ul>
      <p><strong>2. Demand for the Component Auditor's Internal Working Papers (SA 230 & SQC 1):</strong></p>
      <ul>
        <li>Per the explicit guidance under <strong>SA 230</strong> (Audit Documentation) and <strong>SQC 1</strong> (Quality Control framework), audit working papers are the <strong>exclusive property of the auditor who prepares them</strong>.</li>
        <li>A component auditor can, purely at their own professional discretion, share extracts or select copies with the principal auditor, provided it does not undermine their own independence or work validity. However, the principal auditor <strong>cannot claim a legal right to demand access to the working papers</strong> of an independent component auditor.</li>
      </ul>
      <p><strong>Conclusion:</strong></p>
      <p>The dual contentions raised by CA. Soni are entirely <strong>incorrect</strong>. The management's advice to review the distributed final component reports, communicate directly with Rahul K & Associates for logical queries, and coordinate professional discussions aligns accurately with standard practices under SA 600.</p>
    `
  },
  {
    ...
    "solution_html": `
      ...
      <ul>
        ...
        <li>Rather than operating within traditional narrow financial boundaries, it represents a comprehensive structural framework designed to track non-financial metrics using quantitative Environmental, Social, and Governance (ESG) key performance indicators. The Global Reporting Initiative (GRI) framework establishes standard universal criteria to make these disclosures globally comparable.</li>
      </ul>
      <p><strong>Expected Operational and Strategic Benefits:</strong></p>
      <ul>
        <li><strong>Long-Term Value Creation:</strong> Shifts corporate strategy from short-term accounting metrics to long-term operational resilience by highlighting ESG risks and risk mitigation channels.</li>
        <li><strong>Attracting Capital & Investors:</strong> Global institutional funds and contemporary investors increasingly tie funding models directly to an entity's ESG rating. Solid disclosures expand access to cheaper green financing.</li>
        <li><strong>Brand Trust and Supplier Advantage:</strong> Enhances competitive positioning with large Business-to-Business (B2B) multinational customers who require strict supply-chain compliance disclosures from their partners.</li>
        <li><strong>Enhanced Internal Risk Tracking:</strong> Merging financial data and non-financial data forces management to uncover hidden resource waste, environmental compliance exposures, or labor liabilities before they result in legal or regulatory damage.</li>
      </ul>
    `
  },
  {
    ...
    "solution_html": `
      ...
      <ul>
        ...
        <li>The substantive procedures designed by CA. K target assertions deliberately left unexamined in previous years to introduce an <strong>element of unpredictability</strong> into the audit framework (a key requirement under SA 240 to address management override controls).</li>
        <li>If internal audit personnel (who are employees embedded within the company) are utilized to perform these unpredictable procedural checks, the element of surprise is completely compromised. Therefore, assigning these specific checks to Mr. X is <strong>inappropriate and violates SA 610</strong>.</li>
      </ul>
      <p><strong>2. Mandatory Activities Prior to Using Internal Auditors for Direct Assistance:</strong></p>
      <p>If the external auditor intends to use internal auditors for permissible direct assistance tasks, they must execute the following actions *prior* to performance:</p>
      <ol>
        <li><strong>Obtain Written Entity Agreement:</strong> Secure a signed document from an authorized management/TCWG representative confirming that the internal auditors will be permitted to take direct unhindered instructions from the external auditor, and that management will not intervene in their work.</li>
        <li><strong>Obtain Written Confidentiality Agreement from Internal Auditor:</strong> Secure a signed statement from the individual internal auditors (Mr. X or his team) agreeing to keep specific audit matters confidential as directed, and to instantly flag any personal conflict of interest or threat to objectivity.</li>
      </ol>
    `
  },
  {
    ...
    "question_html": `
      ...
      <p>The audit in-charge was going through the draft annual report and observed that the company has included an item in its annual report indicating a downward trend in market prices of key commodities/raw material as compared to the previous year. However, the actual profit margin of the company as reported in financial statements has gone in the reverse direction. The Audit Manager discussed this issue with a partner of the firm who in reply said that auditors are not covered with such disclosures made by the management in its annual report, it being the responsibility of the management.</p>
    ...
    "solution_html": `
      ...
      <ul>
        ...
        <li>"Other Information" includes non-financial summaries, operational trends, and raw material pricing commentaries embedded inside the Annual Report. The auditor must read this data to identify whether a <strong>material inconsistency</strong> exists between the other information and the audited financial statements.</li>
      </ul>
      <p><strong>2. Auditor’s Operational Duties and Response (SA 720):</strong></p>
      <ul>
        <li>The auditor must discuss the contradiction with management (where raw material market costs are claimed to fall, but the actual margins in financial statements drop inexplicably). Management should be asked to validate their statement.</li>
        <li>If the auditor confirms that a <strong>material misstatement of other information</strong> exists and management <strong>refuses to correct it</strong>:
          <ol>
            <li>The auditor must communicate this defiance directly to Those Charged With Governance (TCWG) and request the amendment.</li>
            <li>If it remains uncorrected, the auditor must describe the uncorrected material misstatement under a dedicated <strong>"Other Information"</strong> section inside the formal Audit Report, OR take legal recourse if it impacts the audit opinion.</li>
          </ol>
        </li>
      </ul>
    `
  },
  {
    ...
    "question_html": `
      ...
      <ul>
        <li>Dwelling units exceeding a threshold limit</li>
        <li>Buildings with a total area surpassing a threshold limit</li>
      </ul>
      <p>However, it was noted during the audit that the relevant database did not include a column for entering the area of the building. Consequently, a certain number of buildings were identified as flats even though they had fewer dwelling units than the threshold limit. In the absence of data regarding the area, the audit team directed physical verification of these flats. The physical verification confirmed that these buildings were incorrectly classified as flats, resulting in the department under collecting water charges.</p>
    ...
    "solution_html": `
      ...
      <ul>
        ...
        <li><strong>Nature of Compliance Audit:</strong> It is an independent evaluation to verify whether specific institutional actions, system definitions, data structures, and collections conform to the authoritative legislation or regulations governing the entity. Compliance auditing encompasses two core pillars:
          <ul>
            <li><strong>Regularity:</strong> Ensuring formal structural adherence to statutory criteria, rules, laws, and administrative templates (the database error failing to record "total area" directly breaks regularity controls).</li>
            <li><strong>Propriety:</strong> Observing broader economic principles of sound financial management, vigilance, and ethical code execution to safeguard public revenue. The systemic database gap led to data masking, incorrect categorization, and subsequent under-collection of public water tariffs.</li>
          </ul>
        </li>
      </ul>
      <p><strong>2. Submission Destination of the Audit Report:</strong></p>
      <ul>
        <li>Under <strong>Article 151(2) of the Constitution of India</strong>, the formal audit reports compiled by the Comptroller and Auditor General relating to the accounts and performance of a <strong>State Government department</strong> must be submitted directly to the <strong>Governor of the State</strong>.</li>
        <li>The Governor then directs that these reports be officially laid before the respective <strong>State Legislative Assembly</strong>.</li>
      </ul>
    `
  },
  {
    ...
    "solution_html": `
      ...
      <ul>
        ...
        <li>The guideline specifies that the minimum mandatory documentation includes:
          <ol>
            <li>A structured <strong>Cash Book</strong> tracking chronological transactions.</li>
            <li>A complete, adjusted professional <strong>Ledger</strong>.</li>
          </ol>
        </li>
      </ul>
      <p><strong>Analysis & Conclusion:</strong></p>
      <ul>
        <li>CA. Evan tracks cash receipts via unstructured text notes on a mobile device. Mobile memo logs lack structural balancing controls, double-entry verification trails, and do not constitute proper books of account (Cash Book/Ledger).</li>
        <li>As per <strong>Clause (1) of Part II of the Second Schedule to the CA Act, 1949</strong>, a member is deemed guilty of misconduct if they contravene any guidelines issued by the Council.</li>
        <li>By flouting Chapter V of the Council Guidelines, CA. Evan is <strong>guilty of professional misconduct</strong>.</li>
      </ul>
    `
  },
  {
    ...
    "solution_html": `
      ...
      <ul>
        ...
        <li>Per SRS 4410, if the practitioner becomes aware during the engagement that:
          <ul>
            <li>The compiled financial statements do not accurately reference or describe the applicable financial reporting framework;</li>
            <li>Structural amendments are necessary because the source documents are materially misstated; or</li>
            <li>The compiled statements would otherwise be fundamentally misleading,</li>
          </ul>
          the practitioner is <strong>mandated to propose appropriate corrections/amendments to management</strong>.
        </li>
      </ul>
      <p><strong>Conclusion & Required Course of Action:</strong></p>
      <ul>
        <li>The underlying inventory is grossly understated, and accounting standards are bypassed. The partners' contention that the practitioner must blindly accept these values without dispute is incorrect.</li>
        <li>The practitioner must explicitly request management to correct the inventory and apply the correct accounting framework.</li>
        <li>If the partners decline or block the execution of these corrections, the practitioner <strong>must withdraw from the engagement</strong> and formally communicate the reasons for withdrawal to management and Those Charged With Governance (TCWG).</li>
      </ul>
    `
  },
  {
    ...
    "solution_html": `
      ...
      <ul>
        <li><strong>Forecast:</strong> Prospective financial information prepared based on assumptions of future events that management <strong>fully expects to take place</strong> and the actions management intends to execute as of the preparation date (referred to as <em>best-estimate assumptions</em>).
          <ul>
            <li><em>Example:</em> Based on historical buying trends and settled supply contracts, the management of a company expects sales to grow by 7% over the subsequent quarter. A statement built around this is a financial forecast.</li>
          </ul>
        </li>
        <li><strong>Projection:</strong> Prospective financial information prepared based on <strong>hypothetical assumptions</strong> regarding future paths and events that are not necessarily expected to occur (e.g., when an entity is a new startup or planning a massive structural pivot).
          <ul>
            <li><em>Example:</em> A manufacturing company creates an operational scenario mapping: <em>"What will our net cash flow look like *if* we completely discontinue paper production and build an entirely new commercial chemicals line?"</em> This speculative model is a projection.</li>
          </ul>
        </li>
      </ul>
      <p><strong>2. Nature of Assurance Provided by the Practitioner:</strong></p>
      <ul>
        <li>Prospective information deals with future occurrences that are speculative, uncertain, and may never happen. Evidence validating the underlying assumptions is entirely future-oriented.</li>
        <li>Therefore, the practitioner <strong>cannot express any positive opinion as to whether the final results shown in the prospective statements will actually be achieved</strong>.</li>
        <li>The assurance statement under SAE 3400 is limited to <strong>Negative Assurance</strong>. The practitioner states whether anything came to their attention causing them to believe that the assumptions do not provide a reasonable basis for the information, and whether the statements are prepared properly based on those assumptions.</li>
      </ul>
    `
  },
  {
    ...
    "solution_html": `
      ...
      <ul>
        ...
        <li>Issuing statutory/professional certifications (like a raw material consumption certificate) for an entity constitutes an act of public practice.</li>
        <li>As per <strong>Clause (1) of Part II of the Second Schedule to the Act</strong>, a member (whether in practice or not) is deemed guilty of professional misconduct if they contravene any of the explicit statutory provisions of the Act, Regulations, or Guidelines.</li>
      </ul>
      <p><strong>Analysis & Conclusion:</strong></p>
      <ul>
        <li>CA. Rahul issued a signed compliance certificate holding himself out as a practicing professional when he did not hold an active CoP.</li>
        <li>Applying for the CoP on the subsequent day does not retroactively correct or legalize an unauthorized practice already executed. He directly violated Section 6 of the Act.</li>
        <li>Therefore, CA. Rahul is <strong>guilty of professional misconduct</strong> under Clause (1) of Part II of the Second Schedule to the Chartered Accountants Act, 1949.</li>
      </ul>
    `
  },
  {
    ...
    "solution_html": `
      ...
      <ul>
        ...
        <li><strong>Concealment via Write-offs:</strong> Reporting valid, stolen materials as "damaged in transit," "expired," or "scrap waste" to explain shortages.</li>
        <li><strong>Book Value Manipulation:</strong> Falsifying accounting log numbers to ensure the final book values match a depleted physical count, hiding the deficit.</li>
        <li><strong>Inflating Production Issues:</strong> Overstating the quantities of raw materials transferred into active production, masking siphoned inventories.</li>
        <li><strong>Unrecorded Dispatches:</strong> Shifting goods out to external buyers without generating formal invoices, siphoning cash collections directly.</li>
      </ul>
      <p><strong>2. Detailed Verification Procedure to Detect Defalcation of Inventory:</strong></p>
      <ul>
        <li><strong>System Strength Evaluation:</strong> Review the entire internal control layout tracking receipts, secure storage, and physical dispatches of goods. Look for concentration of power where a single individual handles store entries without independent verification.</li>
        <li><strong>Physical-to-Book Reconciliation:</strong> Conduct unannounced physical counts of construction materials on-site and map them against current inventory balances. Localize and extract discrepancies.</li>
        <li><strong>Document Vouching & Cross-Matching:</strong> Verify the continuous entries in the Inventory Book against historical <em>Goods Inward Registers (GRN)</em>, purchase invoices, and <em>Goods Outward Registers</em>. Ensure items paid for actually entered the site gate, and items leaving have authorized bills.</li>
        <li><strong>Returns & Reversals Audit:</strong> Trace credit notes, sales returns (Inward), and supplier returns (Outward) recorded in financial journals to verify that matching inventory items were returned to storage locations.</li>
        <li><strong>Technical Material Waste Analysis:</strong> In construction setups, management may cover theft by claiming inflated structural material wastage. The investigator should hire an <strong>independent technical engineer</strong> to review the capacity of equipment, design parameters, and benchmark standard wastage rates against historical parameters to flag anomalies.</li>
      </ul>
    `
  },
  {
...
{
  "question_id": "AUD_MTPSEP24II_1A",
  "source": "ICAI Mock Test Paper - Series II, October 2024",
  "chapter_name": "SA 710 – Comparative Information",
  "placement": 1,
  "marks": 5,
  "question_html": `
    <p> Neptune Ltd. is a company that holds significant investments in a portfolio of equity securities. Due to a decline in market values, the company's investments have suffered a notable diminution in value. For the financial year ended 31st March 2023, the audit report of Neptune Ltd. included a qualification regarding the non-provision of ₹ 70 lakh for the diminution in the value of these investments. As the auditor for the financial year 2023-24, how would you report in the following situations:</p>

    <p>(i) If the company does not make a provision for the diminution in the value of investments in the year 2023-24?</p>

    <p>(ii) If the company makes an adequate provision for the diminution in the year 2023-24?</p>
  `,
  "solution_html": `
    <p>As per SA 710, <strong>“Comparative Information – Corresponding Figures and Comparative Financial Statements”</strong>, when the auditor’s report on the prior period, as previously issued, included a qualified opinion, a disclaimer of opinion, or an adverse opinion and the matter which gave rise to the modified opinion is resolved and properly accounted for or disclosed in the financial statements in accordance with the applicable financial reporting framework, the auditor’s opinion on the current period need not refer to the previous modification.</p>

    <p>SA 710 further states that if the auditor’s report on the prior period, as previously issued, included a qualified opinion and the matter which gave rise to the modification is unresolved, the auditor shall modify the auditor’s opinion on the current period’s financial statements. In the Basis for Modification paragraph in the auditor’s report, the auditor shall either:</p>

    <ol type="i">
      <li>Refer to both the current period’s figures and the corresponding figures in the description of the matter giving rise to the modification when the effects or possible effects of the matter on the current period’s figures are material; or</li>

      <li>In other cases, explain that the audit opinion has been modified because of the effects or possible effects of the unresolved matter on the comparability of the current period’s figures and the corresponding figures.</li>
    </ol>

    <p>In the instant case, if Neptune Ltd. does not make provision for diminution in the value of investment to the extent of ₹ 70 lakh, the auditor will have to modify his report for both the current and previous year’s figures as mentioned above. If, however, the provision is made, the auditor need not refer to the earlier year’s modification.</p>
  `
},
{
  ...
  `,
  "solution_html": `
    <p>In the present case based on the audit evidence obtained, CA Shiv has concluded that a material uncertainty exists related to the outcome of the legal dispute, which is uncertain, but if it results in an unfavorable judgment, it could severely impact the Company’s financial position and cash flows. In such circumstances, CA Shiv should express an adverse opinion because the effects on the financial statements of such omission are material and pervasive.</p>

    <p><strong>The relevant extract of the Adverse Opinion Paragraph and Basis for Adverse Opinion paragraph is as under:</strong></p>

    <p><strong>Adverse Opinion</strong></p>

    <p>In our opinion, because of the omission of the information mentioned in the Basis for Adverse Opinion section of our report, the accompanying financial statements do not present fairly, the financial position of the entity as at March 31, 2024, and of its financial performance and its cash flows for the year then ended in accordance with the Accounting Standards issued by the Institute of Chartered Accountants of India.</p>

    <p><strong>Basis for Adverse Opinion</strong></p>

    <p>The financing arrangements of Pratibha Ltd. has expired, and the amount outstanding was payable on March 31, 2024. The entity has been unable to conclude re-negotiations or obtain replacement financing and is considering filing for bankruptcy. This situation indicates that a material uncertainty exists that may cast significant doubt on the Company’s ability to continue as a going concern. The financial statements do not adequately disclose this fact.</p>
  `
},
{
  ...
  `,
  "solution_html": `
    <p>As per section 143(12) of the Companies Act, 2013 read with Rule 13 of the Companies (Audit and Auditors) Rules, 2014, if an auditor of a company in the course of the performance of his duties as auditor, has reason to believe that an offence of fraud, which involves or is expected to involve individually an amount of ₹ 1 crore or above, is being or has been committed in the company by its officers or employees, the auditor shall report the matter to the Central Government within such time and in such manner as prescribed.</p>

    <p>In the given case, CA Guru has reason to believe that a fraud involving ₹ 75 lakhs has been committed in the company by its employees. Therefore, he is under no statutory obligation to report this matter to Central Government by filing prescribed Form (ADT-4) on MCA portal.</p>

    <p>In case of a fraud involving lesser than the specified amount [i.e. less than ₹ 1 crore], the auditor shall report the matter to the audit committee constituted under section 177 or to the Board in other cases within such time and in such manner as prescribed. Besides, auditor has obligation to report matters pertaining to fraud under clause (xi) of paragraph 3 of CARO, 2020.</p>
  `
},
{
  ...
  "question_html": `
    ...
    <p>During financial year 2023-24, Kurukshetra Tech Ltd. implemented an ERP system in phases, leading to the automation of certain business processes. This implementation had a substantial impact on the auditor's overall audit strategy. Mr. Arjun discussed the implementation of such a system with Mr. Krishna and also told him that such matter may be a key audit matter to be reported in the audit report.</p>

    <p>Mr. Krishna considered the significance of said matter, however, he was of the opinion that ERP implementation did not appear to link with the matters disclosed in the financial statements and so there was no need to disclose such matter as a key audit matter.</p>

    <p>Whether the contention of Mr. Krishna is appropriate with respect to the matters to be communicated as a key audit matter?</p>
  `,
  "solution_html": `
    <p>As per SA 701, <strong>‘Communicating Key Audit Matters in the Independent Auditor’s Report’</strong>, the auditor shall determine, from the matters communicated with those charged with governance, those matters that required significant auditor attention in performing the audit. In making this determination, the auditor shall take into account the following:</p>

    <ol type="i">
      <li>Areas of higher assessed risk of material misstatement, or significant risks identified in accordance with SA 315.</li>

      <li>Significant auditor judgments relating to areas in the financial statements that involved significant management judgment, including accounting estimates that have been identified as having high estimation uncertainty.</li>

      <li>The effect on the audit of significant events or transactions that occurred during the period.</li>
    </ol>

    <p>The auditor shall determine which of the aforesaid matters considered were of most significance in the audit of the financial statements of the current period and therefore are the key audit matters.</p>

    <p>These aforesaid considerations focus on the nature of matters communicated with those charged with governance. Such matters are often linked to matters disclosed in the financial statements and are intended to reflect areas of the audit of the financial statements that may be of particular interest to intended users.</p>

    <p>The fact that these considerations are required is not intended to imply that matters related to them are always key audit matters; rather, matters related to such specific considerations are key audit matters only if they are determined to be of most significance in the audit.</p>

    <p>In addition to matters that relate to the specific required considerations, there may be other matters communicated with those charged with governance that required significant auditor attention and that therefore may be determined to be key audit matters. Such matters may include, for example, matters relevant to the audit that was performed that may not be required to be disclosed in the financial statements. For example, the implementation of a new IT system (or significant changes to an existing IT system) during the period may be an area of significant auditor attention, in particular if such a change had a significant effect on the auditor’s overall audit strategy or related to a significant risk (e.g., changes to a system affecting revenue recognition).</p>

    <p>In the given case, there was implementation of ERP system in the company due to which some of its business processes got automated and which had a significant effect on the auditor’s overall audit strategy during the period.</p>

    <p>As per Mr. Arjun, Engagement Partner, above mentioned matter can be considered as a key audit matter and should be reported in the audit report since it requires significant attention that had affected his overall audit strategy. Mr. Krishna, EQCR, considered the significance of said matter, however, he was of the opinion that ERP implementation did not appear to link with the matters disclosed in the financial statements, therefore, no need to disclose such matter as a key audit matter.</p>

    <p>In view of the above, the contention of Mr. Krishna is not appropriate as matters that do not link with the matters disclosed in the financial statements can also be considered as a key audit matter, if it requires significant attention.</p>
  `
},
{
  ...
  "question_html": `
    ...
    <p>Would it make any difference if CA. Kapila had earned income from transacting in currency derivatives and commodity derivatives?</p>
  `,
  "solution_html": `
    <p>Clause 11 of Part I of First Schedule to the Chartered Accountants Act, 1949 states that a Chartered Accountant in practice shall be deemed to be guilty of professional misconduct, if he engages in any business or occupation other than the profession of Chartered Accountants unless permitted by the Council so to engage.</p>

    <p>Provided that nothing contained herein shall disentitle a Chartered accountant from being a director of a Company, (not being a managing director or a whole-time director), unless he or any of his partners is interested in such company as an auditor.</p>

    <p>Ethical Standards Board of ICAI has announced that it is permissible for a member in practice to engage in derivative transactions in his personal capacity but not in professional capacity i.e. for clients. Such engagements in derivatives are not violative of provisions of Clause 11 of Part I of First Schedule to the Chartered Accountants Act, 1949.</p>

    <p>Further, members are allowed to transact in equity and currency derivatives. There is no requirement to take permission of Council in this matter.</p>

    <p>Therefore, there is no difference if CA. Kapila had earned income from currency derivatives. However, in accordance with announcement of Ethical Standards Board of ICAI, it is not permissible for members in practice to transact in commodity derivative transactions. In such a case, CA. Kapila would be held guilty of professional misconduct for engaging in business other than profession of Chartered Accountancy.</p>
  `
},
{
  ...
  `,
  "solution_html": `
    <p><strong>Advantages and Disadvantages of Remote Audit:</strong></p>
    ...
    <table border="1" cellspacing="0" cellpadding="6">
      ...
      <tbody>
        <tr>
          <td>Cost and time effective: No travel time and travel costs involved.</td>
          <td>Due to network issues, interviews and meetings can be interrupted.</td>
        </tr>
        <tr>
          <td>Comfort and flexibility to the audit team as they would be working from home environment.</td>
          <td>Limited or no ability to visualize facility culture of the organization, and the body language of the auditees. Time zone issues could also affect the efficiency of remote audit session.</td>
        </tr>
        <tr>
          <td>Time required to gather evidence can spread over several weeks, instead of concentrated into a small period that takes personnel from their daily activities.</td>
          <td>The opportunity to present doctored documents and to omit relevant information is increased. This may call for additional planning, some additional/different audit procedures, Security and confidentiality violation.</td>
        </tr>
        <tr>
          <td>Auditor can get first-hand evidence directly from the IT system as direct access may be provided.</td>
          <td>Remote access to sensitive IT systems may not be allowed. Security aspects related to remote access and privacy needs to be assessed.</td>
        </tr>
        <tr>
          <td>Widens the selection of auditors from global network of experts.</td>
          <td>Cultural challenges for the auditor. Lack of knowledge for local laws and regulations could impact audit. Audit procedures like physical verification of assets and stock taking cannot be performed.</td>
        </tr>
      </tbody>
    </table>
  `
},
{
  ...
  "question_html": `
    ...
    <p>During the audit, it was observed that there is a significant understatement in the value of trade receivables. The trade receivable valuation work was looked after by AB & Associates, however, there was no documentation outlining the division of the work between the joint auditors.</p>

    <p>Comment on the above situation with respect to the allocation of responsibilities among joint auditors as per relevant Standards on Auditing.</p>
  `,
  "solution_html": `
    <p><strong>Responsibility and Co-ordination among Joint Auditors:</strong> As per SA 299, <strong>“Joint Audit of Financial Statements”</strong>, where joint auditors are appointed, they should, by mutual discussion, divide the audit work among themselves. The division of the work would usually be in terms of audit identifiable units or specified area. In some cases, due to the nature of the business entity under audit, such a division of the work may not be possible. In such situations, the division of the work may be with reference to items of assets or liabilities or income or expenditure or with reference to period of time. The division of the work among joint auditors as well as the areas of work to be covered by all of them should be adequately documented and preferably communicated to the entity.</p>

    <p>In respect of the audit work divided among the joint auditors, each joint auditor is responsible only for the work allocated to him, whether or not he has prepared a separate audit of the work performed by him. On the other hand all the joint auditors are jointly and severally responsible –</p>

    <ol type="i">
      <li>The audit work which is not divided among the joint auditors and is carried out by all joint auditors;</li>

      <li>Decisions taken by all the joint auditors under audit planning phase concerning the nature, timing and extant of the audit procedure to be performed by each of the auditor;</li>

      <li>Matters which are bought to the notice of the joint auditors by any one of them and on which there is an agreement among the joint auditors;</li>

      <li>Examining that the financial statements of the entity comply with the requirements of the relevant statute;</li>

      <li>Presentation and disclosure of financial statements as required by the applicable financial reporting framework;</li>

      <li>Ensuring that the audit report complies with the requirements of the relevant statutes, the applicable Standards on Auditing and the other relevant pronouncements issued by ICAI;</li>
    </ol>

    <p>The joint auditors shall also discuss and document the nature, timing, and the extent of the audit procedures for common and specific allotted areas of audit to be performed by each of the joint auditors and the same shall be communicated to those charged with governance. After identification and allocation of work among the joint auditors, the work allocation document shall be signed by all the joint auditors and the same shall be communicated to those charged with governance of the entity.</p>

    <p>Hence, in respect of audit work divided among the joint auditors, each joint auditor shall be responsible only for the work allocated to such joint auditor including proper execution of the audit procedures.</p>

    <p>In the instant case, Studio Ltd. appointed two CA Firms AB & Associates and CD & Co. as joint auditors for conducting audit. As observed during the course of audit that there is a significant understatement in the value of trade receivable and valuation of trade receivable work was looked after by AB & Associates.</p>

    <p>In view of SA 299, AB & Associate will be held responsible for the same as trade receivable valuation work was looked after by AB & Associates only. Further, there is violation of SA 299 as the division of work has not been documented.</p>
  `
},
{
  ...
  `,
  "solution_html": `
    <p>As per Clause (xvi) of Paragraph 3 of CARO 2020, the auditor is required to report that “whether the company is required to be registered under section 45-IA of the Reserve Bank of India Act, 1934 and if so, whether the registration has been obtained.”</p>

    <p>The auditor is required to examine whether the company is engaged in the business which attracts the requirement of the registration. The registration is required where the financing activity is a principal business of the company. The RBI restrict companies from carrying on the business of a non-banking financial institution without obtaining the certificate of registration.</p>

    <p><strong>Audit Procedures and Reporting:</strong></p>

    <ol type="i">
      <li>The auditor should examine the transactions of the company with relation to the activities covered under the RBI Act and directions related to the Non-Banking Financial Companies.</li>

      <li>The financial statements should be examined to ascertain whether company’s financial assets constitute more than 50 per cent of the total assets and income from financial assets constitute more than 50 per cent of the gross income.</li>

      <li>Whether the company has net owned funds as required for the registration as NBFC.</li>

      <li>Whether the company has obtained the registration as NBFC, if not, the reasons should be sought from the management and documented.</li>

      <li>The auditor should report incorporating the following:
        <ol>
          <li>Whether the registration is required under section 45-IA of the RBI Act, 1934.</li>
          <li>If so, whether it has obtained the registration.</li>
          <li>If the registration not obtained, reasons thereof.</li>
        </ol>
      </li>
    </ol>

    <p>In the given case, Manu Finance Ltd. is a Non-Banking Finance Company and was in the business of accepting public deposits and giving loans since 2019. The company was having net owned funds of ₹ 1,75,00,000/- (one crore seventy five lakhs) which is less in comparison to the prescribed limit i.e. 2 crore rupees and was also not having registration certificate from RBI (though applied for it on 29th March 2024). The auditor is required to report on the same as per Clause (xvi) of Paragraph 3 of CARO 2020.</p>
  `
},
{
  ...
  "question_html": `
    ...
    <p>Comment with reference to the Chartered Accountants Act, 1949 and Schedules thereon.</p>
  `,
  "solution_html": `
    <p>According to Clause (7) of Part I of Second Schedule to the Chartered Accountants Act, 1949, a Chartered Accountant in practice is deemed to be guilty of professional misconduct if he “does not exercise due diligence or is grossly negligent in the conduct of his professional duties”.</p>

    <p>It is a vital clause which usually gets attracted whenever it is necessary to judge whether the accountant has honestly and reasonably discharged his duties. The expression negligence covers a wide field and extends from the frontiers of fraud to collateral minor negligence.</p>

    <p>In the instant case, DIGI & Associate did not exercise due diligence and is grossly negligent in the conduct of his professional duties since it did not visit the site where the stock was lying and instead the firm relied on the MIS report along with inspection reports and photographs of stock taken by the employees of PQR Ltd, which is incorrect.</p>

    <p>To conduct stock audit, ascertainment of existence and physical condition of stocks, cross tallying the stock with Stock statement submitted by bank borrower, correct classification of stocks for valuation purpose etc. is essential. Further submitting stock audit report without physically verifying the stock amounts to gross negligence.</p>

    <p>From the above, it can be concluded that DIGI & Associate is guilty of professional misconduct under Clause (7) of Part I of Second Schedule to the Chartered Accountants Act, 1949.</p>
  `
},
{
  ...
  `,
  "solution_html": `
    <p><strong>Consolidation of Financial Statement:</strong> As per Ind AS 110, there is no such exemption for ‘temporary control’, or “for operation under severe long-term funds transfer restrictions” and consolidation is mandatory for Ind AS compliant financial statement in this case. Paragraph 20 of Ind AS 110 states that “Consolidation of an investee shall begin from the date the investor obtains control of the investee and cease when the investor loses control of the investee”.</p>

    <p>However, as per Section 129(3) of the Companies Act, 2013 read with rule 6 of the Companies (Accounts) Rules, 2014, where a company having subsidiary, which is not required to prepare consolidated financial statements under the Accounting Standards, it shall be sufficient if the company complies with the provisions on consolidated financial statements provided in Schedule III to the Act.</p>

    <p>In the given case, Girdhar Ltd.’s intention is disposal of the shares in the near future as shares are being held as stock in trade and it is quite clear that the control is temporary. Therefore, Girdhar Ltd. is required to prepare Consolidated Financial Statements in accordance with Ind AS 110 as exemption for ‘temporary control’ is not available in the same.</p>
  `
},
{
  ...
  `,
  "solution_html": `
    <p>Section 2(45) of the Companies Act, 2013, defines a “Government Company” as a company in which not less than 51% of the paid-up share capital is held by the Central Government or by any State Government or Governments or partly by the Central Government and partly by one or more State Governments, and includes a company which is a subsidiary company of such a Government company.</p>

    <p>The auditors of these government companies are firms of Chartered Accountants, appointed by the Comptroller & Auditor General, who gives the auditor directions on the manner in which the audit should be conducted by them.</p>

    <p>In the given situation, Abhinandan Ltd. is a company wholly owned by Delhi Government was disinvested during the previous year, resulting in 38% of the shares being held by public. The shares were also listed on the NSE. The listing of company’s shares on a stock exchange is irrelevant for this purpose and hence, opinion of finance manager Paras is not correct.</p>
  `
},
{
  ...
  "question_html": `
    ...
    <p>Comment on the act of CA Ram in terms of the Chartered Accountant Act, 1949 and Schedules thereon.</p>
  `,
  "solution_html": `
    <p>Under Section 2(2)(iv) of the Chartered Accountants Act, 1949, a member of the Institute shall be deemed “to be in practice” when individually or in partnership with Chartered Accountants in practice, he, in consideration of remuneration received or to be received renders such other services as, in the opinion of the Council, are or may be rendered by a Chartered Accountant in practice.</p>

    <p>Pursuant to Section 2(2)(iv) of the Chartered Accountants Act, 1949, read with Regulation 191 of Chartered Accountants Regulations, 1988 a member shall be deemed to be in practice if he, in his professional capacity and neither in his personal capacity nor in his capacity as an employee, acts as representative for taxation matters.</p>

    <p>In the given situation, CA Ram, a practicing Chartered Accountant, provides non-assurance services. He is approached by DEF Limited, a non-audit client, to file an appeal in GST Tribunal against GST Demand of ₹ 6 crore, which was imposed by the Commissioner (Appeals) and to plead on behalf of DEF Limited in the matter. CA Ram offers to accept the case and agrees to charge fees of ₹ 3,50,000.</p>

    <p>Therefore, CA Ram is not guilty of professional misconduct.</p>
  `
},
{
  ...
  "question_html": `
    ...
    <p>Management was looking for some financial investor who can fund some part of the proposed expansion. Mr. Aman is interested in the venture and appoints you to act as an advisor to the proposed investment in the business of Quality Ltd.</p>

    <p>You have to investigate the audited financial statements and ensure that the valuation of shares of the company on the basis of audited financial statements is appropriate.</p>

    <p>What process will be used for checking and can reliance be placed on the already audited statement of accounts?</p>
  `,
  "solution_html": `
    

    <p>In the instant case, Quality Ltd. is engaged in the business of manufacturing and distribution of various ready-to-cook products like vegetables, noodles etc. Further, management was looking for some financial investor to fund some part of the proposed expansion. Aman is interested in funding; therefore, he initiated investigation of audited financial statements to ensure the appropriateness of the valuation of the shares.</p>

    <p>For initiating the same it may be considered that if the investigation has been launched because of some doubt in the audited statement of account, no question of reliance on the audited statement of account arises.</p>

    <p>However, if the investigator has been requested to establish value of a business or a share or the amount of goodwill payable by an incoming partner, ordinarily the investigator would be entitled to put reliance on audited materials made available to him unless, in the course of his test verification, he finds the audit to have been carried on very casually or unless his terms of appointment clearly require to test everything afresh.</p>

    <ul>
      <li>If the statements of account produced before the investigator were not audited by a qualified accountant, then of course there arises a natural duty to get the figures in the accounts properly checked and verified.</li>

      <li>However, when the accounts produced to the investigator have been specially prepared by a professional accountant, who knows or ought to have known that these were prepared for purposes of the investigation, he could accept them as correct relying on the principle of liability to third parties.</li>

      <li>It would be prudent to see first that such accounts were prepared with objectivity and that no bias has crept in to give advantage to the person on whose behalf these were prepared.</li>
    </ul>
  `
},
{
  ...
  "question_html": `
    ...
    <p>Management, to estimate full-year revenue, extrapolated the sales for 11 months to arrive at a figure for 12 months. However, given the nature of MINI Builders as a company in the construction sector, where monthly sales exhibit substantial variations, a unique challenge emerged.</p>

    <p>The actual sales for the last month deviated significantly from the estimated sales due to an unexpected slowdown in project completions. As a result, the last month's actual sales represented only 30% of the estimated sales.</p>

    <p>Now, Mr. Gautam is confronted with a dilemma regarding the appropriate approach to evaluate uncorrected misstatements using the previously calculated materiality.</p>

    <p>Kindly Guide Mr. Gautam in the light of relevant Standards on Auditing.</p>
  `,
  "solution_html": `
    

    <p>As per SA 450, <strong>“Evaluation of Misstatements Identified during the Audit”</strong>, the auditor is required to reassess materiality, in accordance with SA 320 <strong>“Materiality in Planning and Performing an Audit”</strong>, before evaluating the impact of uncorrected misstatements. This reassessment is crucial to confirm the ongoing appropriateness of materiality in light of the entity's actual financial results.</p>

    <p>The determination of materiality under SA 320 often relies on estimates of the entity's financial results, given that the actual results may not be known during the early stages of the audit. Therefore, before the auditor proceeds to assess the effect of uncorrected misstatements, it becomes necessary to adjust the materiality calculated under SA 320 based on the now available actual financial results.</p>

    <p>SA 320 outlines that, as the audit progresses, materiality may be revised for the financial statements as a whole or for specific classes of transactions, account balances, or disclosures. This revision is prompted by the auditor's awareness of information that would have led to a different initial determination.</p>

    <p>Typically, significant revisions occur before the evaluation of uncorrected misstatements. However, if the reassessment of materiality under SA 320 results in a lower amount, the auditor must reconsider performance materiality and the appropriateness of the audit procedures' nature, timing, and extent. This is crucial for obtaining sufficient and appropriate audit evidence on which to base the audit opinion.</p>

    <p>In the present case involving MINI Builders Private Limited, it has been identified that the materiality calculated at the beginning of the audit for revenue was based on estimates provided by the management. The management extrapolated sales for the full year using the actual amount of 11 months, but since the company experiences significant monthly variations in sales, the actual sales for the last month were only 30% of the estimated figure. This discrepancy arose due to an unexpected slowdown in project completions.</p>

    <p>In this audit scenario, Mr. Gautam, the auditor, must re-assess the materiality initially determined under SA 320 to ensure its continued validity in light of the actual financial results.</p>

    <p>If the re-assessed materiality is lower than the previously calculated amount, Mr. Gautam must reconsider performance materiality and the appropriateness of the nature, timing, and extent of further audit procedures. This meticulous approach is essential to gather sufficient and appropriate audit evidence, enabling Mr. Gautam to form an independent and objective opinion on the financial statements of MINI Builders Private Limited.</p>
  `
},
{
  ...
  "question_html": `
    ...
    <p>Following further information is provided in respect of the above company:</p>

    <p><strong>(i)</strong> It has secured a loan to expand its operations and invests the funds in purchasing raw materials and machinery. The loan, along with revenue generated from existing sales, contributes to the pool of resources available for production.</p>

    <p><strong>(ii)</strong> It has increased the number of beneficiaries under its flagship CSR programmes from previous 10000 to 75000. It has provided value for communities and provided sustainable livelihood to them.</p>

    <p>Discussing the above information, identify which of the capitals of <strong>“Integrated Reporting”</strong> are being referred to at <strong>[i]</strong> and <strong>[ii]</strong> respectively?</p>
  `,
  "solution_html": `
    

    <p>The information given in situation <strong>[i]</strong> states that the company has secured a loan to expand its operations and invests the funds in purchasing raw materials and machinery. The loan, along with revenue generated from existing sales, contributes to the pool of resources available for production.</p>

    <p>Therefore, it involves a pool of funds that is available to the organization for use in the production of goods or provision of services. Further, it is obtained through financing, such as debt, equity, or grants, or generated through operations or investments.</p>

    <p>The capital referred to at <strong>[i]</strong> is <strong>“Financial Capital”.</strong></p>

    <hr>

    <p>Further, situation <strong>[ii]</strong> describes an increase in the number of beneficiaries under flagship CSR programmes, providing value for communities and sustainable livelihood.</p>

    <p>This is an example of relationships established within and between each community, group of stakeholders and other networks to enhance individual and collective well-being.</p>

    <p>The capital referred to at <strong>[ii]</strong> is <strong>“Social and Relationship Capital”.</strong></p>
  `
},
{
  ...
  "question_html": `
    ...
    <p>Black Mountain Mining Ltd. re-appointed Mr. Aman as an independent expert for this task. For the past five years, the management has consistently re-appointed Mr. Aman. He calculated the environmental liabilities for both completed mining sites and sites scheduled for closure in the near future, including provisions for clean-up costs. Management accepted his assessment.</p>

    <p>Mr. Atharv, after performing the inquiries with management, was of the opinion that the objectivity of the independent expert cannot be questioned just because he was appointed by management as their expert. Hence, there is no need to raise a question on the objectivity of Mr. Aman or on his work performed for the company.</p>

    <p>However, the audit partner was of the opinion that the audit team needs to evaluate the objectivity of an expert engaged by the entity, irrespective of the fact that he was appointed as an independent expert.</p>

    <p>Guide the audit partner and Mr. Atharv with respect to requirements pertaining to evaluating the objectivity of the management expert.</p>
  `,
  "solution_html": `
    <p><strong>Solution:</strong></p>

    <p>As per SA 500 <strong>“Audit Evidence”</strong>, when information to be used as audit evidence has been prepared using the work of a management’s expert, the auditor shall, to the extent necessary, have regard to the significance of that expert’s work for the auditor’s purposes and evaluate the competence, capabilities and objectivity of that expert.</p>

    <p>A broad range of circumstances may threaten objectivity, for example:</p>

    <ul>
      <li>Self-interest threats</li>
      <li>Advocacy threats</li>
      <li>Familiarity threats</li>
      <li>Self-review threats</li>
      <li>Intimidation threats</li>
    </ul>

    <p>Safeguards may reduce such threats and may be created either by external structures (for example, the management expert’s profession, legislation or regulation), or by the management expert’s work environment (for example, quality control policies and procedures).</p>

    <p>Although safeguards cannot eliminate all threats to a management expert’s objectivity, threats such as intimidation threats may be of less significance to an expert engaged by the entity than to an expert employed by the entity.</p>

    <p>When evaluating the objectivity of an expert engaged by the entity, it may be relevant to discuss with management and that expert any interests and relationships that may create threats to the expert’s objectivity and any applicable safeguards, including any professional requirements that apply to the expert.</p>

    <p>Interests and relationships creating threats may include:</p>

    <ul>
      <li>Financial interests.</li>
      <li>Business and personal relationships.</li>
      <li>Provision of other services.</li>
    </ul>

    <p>In the current case, Black Mountain Mining Ltd. re-appointed Mr. Aman for this engagement as an independent expert. The audit team was of the view that the objectivity of the independent expert cannot be questioned just because he was appointed by management as their expert.</p>

    <p>However, the audit partner had a contrary view. The audit team should evaluate the objectivity of an expert engaged by the entity as the threat to objectivity, created by being an employee of the entity, will always be present.</p>

    <p>An expert appointed by the entity cannot ordinarily be regarded as being more likely to be objective than other employees of the entity.</p>

    <p>Therefore, the view of the audit partner is correct and the audit team needs to evaluate the objectivity of Mr. Aman before relying on his work.</p>
  `
},
{
  ...
  "question_html": `
    ...
    <p>(i) Asking for information or issue of questionnaire.</p>

    <p>(ii) Initiating and stamping of vouchers and of schedules prepared for the purpose of audit.</p>

    <p>(iii) Acknowledging and carrying on routine correspondence with clients.</p>

    <p>Comment on eligibility of Mr. Vijay for conducting such jobs in name of M/s Adhya & Co. and liability of Mr. Jay under the Chartered Accountants Act, 1949.</p>
  `,
  "solution_html": `
    <p>Delegation of Authority to the Employee: As per Clause (12) of Part I of the First Schedule of the Chartered Accountants Act, 1949, a Chartered Accountant in practice is deemed to be guilty of professional misconduct “if he allows a person not being a member of the Institute in practice or a member not being his partner to sign on his behalf or on behalf of his firm, any balance sheet, profit and loss account, report or financial statements”.</p>

    <p>In this case CA Jay proprietor of M/s Adhya & Co., went to abroad and delegated the authority to another Chartered Accountant Mr. Vijay, his employee, for taking care of routine matters of his office who is not a partner but a member of the Institute of Chartered Accountants of India.</p>

    <p>The Council has clarified that the power to sign routine documents on which a professional opinion or authentication is not required to be expressed may be delegated and such delegation will not attract provisions of this clause.</p>

    <p>In the given case, Mr. Vijay, a Chartered Accountant being employee of M/s Adhya & Co. has asked for information or issued questionnaire. He has also proceeded for initiating and stamping of vouchers and of schedules prepared for the purpose of audit. Apart from the same, he acknowledged and carried out routine correspondence with clients.</p>

    <p>Here Vijay is right in doing the same, since the same falls under routine work which can be delegated by the auditor.</p>

    <p>Therefore, there is no misconduct in this case as per Clause (12) of Part I of First Schedule to the Act.</p>
  `
},
{
  ...
  "question_html": `
    ...
    <p>In view of the above, mention the responsibilities of the management to be agreed on for the compilation engagement in accordance with SRS 4410.</p>

    <p><strong>OR</strong></p>

    <p>A review of financial statements includes consideration of the entity’s ability to continue as a going concern. If, during the performance of the review, the practitioner becomes aware of events or conditions that may cast significant doubt about the entity’s ability to continue as a going concern.</p>

    <p>Enumerate the steps to be taken by the practitioner for the same.</p>
  `,
  "solution_html": `
    <p>The practitioner shall not accept the compilation engagement unless the practitioner has agreed the terms of engagement with management, and the engaging party if different.</p>

    <p>In accordance with SRS 4410, <strong>“Compilation Engagement”</strong>, the responsibilities of the management to be agreed on for the compilation engagement are that:</p>

    <ol>
      <li>
        <p>The financial information, and for the preparation and presentation thereof, in accordance with a financial reporting framework that is acceptable in view of the intended use of the financial information and the intended users.</p>
      </li>

      <li>
        <p>Design, implementation and maintenance of such internal control as management determines is necessary to enable the preparation of financial statements that are free from material misstatement, whether due to fraud or error.</p>
      </li>

      <li>
        <p>The accuracy and completeness of the records, documents, explanations and other information provided by management for the compilation engagement.</p>
      </li>

      <li>
        <p>Judgments needed in the preparation and presentation of the financial information, including those for which the practitioner may provide assistance in the course of the compilation engagement.</p>
      </li>
    </ol>
    ...
    <p>As per SRE 2400, <strong>“Engagements to Review Historical Financial Statements”</strong>, a review of financial statements includes consideration of the entity’s ability to continue as a going concern.</p>

    <p>If, during the performance of the review, the practitioner becomes aware of events or conditions that may cast significant doubt about the entity’s ability to continue as a going concern, the practitioner shall:</p>

    <ol>
      <li>
        <p>Inquire of management about plans for future actions affecting the entity’s ability to continue as a going concern and about the feasibility of those plans, and also whether management believes that the outcome of those plans will improve the situation regarding the entity’s ability to continue as a going concern.</p>
      </li>

      <li>
        <p>Evaluate the results of those inquiries, to consider whether management’s responses provide a sufficient basis to:</p>

        <ol type="a">
          <li>
            <p>Continue to present the financial statements on the going concern basis if the applicable financial reporting framework includes the assumption of an entity’s continuance as a going concern; or</p>
          </li>

          <li>
            <p>Conclude whether the financial statements are materially misstated or are otherwise misleading regarding the entity’s ability to continue as a going concern.</p>
          </li>
        </ol>
      </li>

      <li>
        <p>Consider management’s responses in light of all relevant information of which the practitioner is aware as a result of the review.</p>
      </li>
    </ol>
  `
},
