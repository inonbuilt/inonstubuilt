...
function generateExamData() {
    ...
    // Changed to Paper 5: Indirect Tax Laws
    rawExamElements.push(`
        <div class="watermark">CAM2</div>
        <div class="header-center">FINAL EXAM<br>PAPER - 5<br>${examDate}<br>INDIRECT TAX LAWS</div>
    ...
    if (!examCompleted) {
        ...
        // Points back to eidt.html
        rawExamElements.push(`<button id="home-btn" class="finish-exam-btn no-split" style="display:block; background:#0f172a; color:white; margin-top:15px;" onclick="window.location.href='./eidt.html'">Return to Home</button>`);
    }
}
